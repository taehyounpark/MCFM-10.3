...
extern "C" {
  ...
  void qqb_gamgam_v_(double *p,double *msqv);
}

namespace MCFM {

  class qqb_gamgam: public Process {
  public:
	...
	if (legs[i].Mass()) return false;
	  ...
	  legs[3].m_fl==-legs[2].m_fl)
	return interface->AddProcess(pi,new qqb_gamgam(legs))>-1;
      return false;
    }

    qqb_gamgam(const std::vector<Leg> &legs):
      Process(legs,3,2) {
