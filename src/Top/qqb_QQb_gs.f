...
c      msq(j,k)=
c     & +msqc(1,j,k)+msqc(2,j,k)+msqc(3,j,k)+msqc(4,j,k)
c     & +msqc(5,j,k)+msqc(6,j,k)+msqc(7,j,k)+msqc(8,j,k)
c     & +msqc(9,j,k)+msqc(10,j,k)+msqc(11,j,k)+msqc(12,j,k)
