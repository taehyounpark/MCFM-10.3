...
c--- One extra parameter needed for non-identical quark pieces
      parameter(iqr=7,i5=7,i6=8)


      xl12=log(+two*dot(p,1,2)/musq)
      xl15=log(-two*dot(p,1,i5)/musq)
      xl16=log(-two*dot(p,1,i6)/musq)
      xl25=log(-two*dot(p,2,i5)/musq)
      xl26=log(-two*dot(p,2,i6)/musq)
      xl56=log(+two*dot(p,i5,i6)/musq)
