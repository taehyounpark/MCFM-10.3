...
c======missing bubble piece
 ...
 !     write(6,*) 'total/LO',amp_qqbQQbga_mhvalt_del1_lc*im/ALO
      ...
      Vpole= -6._dp - 2*epinv*epinv2
     & -  lnrat(musq,-s(i1,i2))**2/2._dp
...
c      write(6,*) boxcoeff(1)/2._dp*(s(i2,i4)*s(i3,i4))*im
c      write(6,*) boxcoeff(2)/2._dp*(s(i1,i3)*s(i3,i4))*im
c      write(6,*) boxcoeff(3)/2._dp*(s(i1,i5)*s(i1,i3))*im
c      write(6,*) boxcoeff(4)/2._dp*(s(i2,i5)*s(i2,i4))*im
...
c      write(6,*) 'total ', amp_qqbQQbga_mhvalt_del2_lc*im
c      write(6,*) 'pole pieces',Vpole*im
c      write(6,*) 'boxes ',Boxes*im
c      write(6,*) 'bubs ',Bubs*im
c      write(6,*) 'completed rat',rat*im
c      write(6,*) 'total/LO',amp_qqbQQbga_mhvalt_del2_lc*im/ALO
...
c===  plus correction for deviation from del1 slc
...
c      write(6,*) 'total ', amp_qqbQQbga_mhvalt_del2_slc*im
c      write(6,*) 'pole pieces',Vpole*im
c      write(6,*) 'boxes ',Boxes*im
c      write(6,*) 'bubs ',Bubs*im
c      write(6,*) 'completed rat',rat*im
c      write(6,*) 'total/LO',amp_qqbQQbga_mhvalt_del2_slc*im/ALO
