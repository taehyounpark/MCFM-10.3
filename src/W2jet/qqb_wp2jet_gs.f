...
c***********************************************************************
      subroutine qqb_wp2jet_gs(p,msq)
      implicit none
      include 'types.f'
c***********************************************************************
...
c--- 20/5/09: symmetrized 65 between _1 and _2
...
c--- W radiated from the gluon line, all quarks
     ...
     &     +m15_2vx(0,0,1,-2))
          ...
          Vckm=Vsq(j,-j+1)
          msq(23,j,k)=msq(23,j,k)+sub27_1(qg)*(aveqg/aveqq)*(
     &     +(xn-xninv )*(  m27_1x(0,+2,+1,+1,+1)+m27_1x(0,+2,+2,+2,+1)
     &       +real(nf-2,dp)*m27_1x(0,+2,+3,+1,+3)+m27_1x(0,+2,+4,+2,+3))
     &     +(xn-xninv )*(  m27_1x(1,+2,+1,+1,+1)+m27_1x(1,+2,+2,+2,+1)
     &       +real(nf-2,dp)*m27_1x(1,+2,+3,+1,+3)+m27_1x(1,+2,+4,+2,+3))
     &     +(xn-xninv )*(  m27_1x(2,+2,+1,+1,+1)+m27_1x(2,+2,+2,+2,+1)
     &      +real(nf-2,dp)*m27_1x(2,+2,+3,+1,+3)+m27_1x(2,+2,+4,+2,+3)))
          msq(24,j,k)=msq(24,j,k)+sub25_1(qg)*(aveqg/aveqq)*Vckm*(
     &     +(xn-xninv )*(m25_1x(0,2,-2,1,-2)+0.5_dp*m25_1x(0,2,-1,1,-1)
     &                  +m25_1x(0,2,-1,4,-4)+m25_1x(0,2,-1,3,-3)*2._dp
     &                  +m25_1x(0,2,-2,3,-4))
     &     +(xn-xninv )*(m25_1x(1,2,-2,1,-2)+0.5_dp*m25_1x(1,2,-1,1,-1)
     &                  +m25_1x(1,2,-1,4,-4)+m25_1x(1,2,-1,3,-3)*2._dp
     &                  +m25_1x(1,2,-2,3,-4))
     &     +(xn-xninv )*(m25_1x(2,2,-2,1,-2)+0.5_dp*m25_1x(2,2,-1,1,-1)
     &                  +m25_1x(2,2,-1,4,-4)+m25_1x(2,2,-1,3,-3)*2._dp
     &                  +m25_1x(2,2,-2,3,-4)))
          msq(22,j,k)=msq(22,j,k)+sub26_1(qg)*(aveqg/aveqq)*Vckm*(
     &     +(xn-xninv )*(m26_1x(0,2,-1,2,-2)+0.5_dp*m26_1x(0,2,-1,1,-1)
     &                  +m26_1x(0,2,-4,1,-4)+m26_1x(0,2,-3,1,-3)*2._dp
     &                  +m26_1x(0,2,-3,2,-4))
     &     +(xn-xninv )*(m26_1x(1,2,-1,2,-2)+0.5_dp*m26_1x(1,2,-1,1,-1)
     &                  +m26_1x(1,2,-4,1,-4)+m26_1x(1,2,-3,1,-3)*2._dp
     &                  +m26_1x(1,2,-3,2,-4))
     &     +(xn-xninv )*(m26_1x(2,2,-1,2,-2)+0.5_dp*m26_1x(2,2,-1,1,-1)
     &                  +m26_1x(2,2,-4,1,-4)+m26_1x(2,2,-3,1,-3)*2._dp
     &                  +m26_1x(2,2,-3,2,-4)))
...
c--- 26/5/09: added additional 57_6 and 67_5 and divided as in Gflag gg dips
     ...
     &     +m17_5x(0,2,0,0,1)+m17_5x(2,2,0,0,1))
     ...
     &      sub67_5(gq)*(
     &         +m67_5x(0,2,0,1,0)+m67_5x(1,2,0,1,0))
...
c------- Qbar-G
     ...
     &                  +m27_1(2,j,-4)+m27_1(2,j,-5)))
          msq(24,j,k)=msq(24,j,k)+sub25_1(qg)*(aveqg/aveqq)*(
     &     +(xn-xninv )*(0.5_dp*m25_1x(0,-2,2,-2,1)+m25_1x(0,-2,2,-4,3))
     &     +(xn-xninv )*(0.5_dp*m25_1x(1,-2,2,-2,1)+m25_1x(1,-2,2,-4,3))
     &     +(xn-xninv )*(0.5_dp*m25_1x(2,-2,2,-2,1)+m25_1x(2,-2,2,-4,3)))
          msq(22,j,k)=msq(22,j,k)+sub26_1(qg)*(aveqg/aveqq)*(
     &     +(xn-xninv )*(0.5_dp*m26_1x(0,-2,2,-2,1)+m26_1x(0,-2,4,-2,3))
     &     +(xn-xninv )*(0.5_dp*m26_1x(1,-2,2,-2,1)+m26_1x(1,-2,4,-2,3))
     &     +(xn-xninv )*(0.5_dp*m26_1x(2,-2,2,-2,1)+m26_1x(2,-2,4,-2,3)))
     ...
     &     +m27_1x(0,-1,-4,-2,-4)*Vckm*real(nf-2,dp)
     &     +m27_1x(0,-1,-2,-2,-2)*Vckm
     &     +m27_1x(0,-1,-3,-1,-4)*(2._dp-Vckm)
     &     +m27_1x(1,-1,-1,-1,-2)*Vckm
     &     +m27_1x(1,-1,-4,-2,-4)*Vckm*real(nf-2,dp)
     &     +m27_1x(1,-1,-2,-2,-2)*Vckm
     &     +m27_1x(1,-1,-3,-1,-4)*(2._dp-Vckm)
     &     +m27_1x(2,-1,-1,-1,-2)*Vckm
     &     +m27_1x(2,-1,-4,-2,-4)*Vckm*real(nf-2,dp)
     &     +m27_1x(2,-1,-2,-2,-2)*Vckm
     &     +m27_1x(2,-1,-3,-1,-4)*(2._dp-Vckm))
          msq(24,j,k)=msq(24,j,k)+
     &     sub25_1(qg)*(aveqg/aveqq)*(xn-xninv )*(
     &         +Vckm*(m25_1x(0,-1,1,-2,1)
     &                +real(nf-2,dp)*m25_1x(0,-1,2,-4,4)
     &                +0.5_dp*m25_1x(0,-1,2,-2,2))
     &    +(2._dp-Vckm)*m25_1x(0,-1,1,-4,3)
     &         +Vckm*(m25_1x(1,-1,1,-2,1)
     &                +real(nf-2,dp)*m25_1x(1,-1,2,-4,4)
     &                +0.5_dp*m25_1x(1,-1,2,-2,2))
     &    +(2._dp-Vckm)*m25_1x(1,-1,1,-4,3)
     &         +Vckm*(m25_1x(2,-1,1,-2,1)
     &                +real(nf-2,dp)*m25_1x(2,-1,2,-4,4)
     &                +0.5_dp*m25_1x(2,-1,2,-2,2))
     &    +(2._dp-Vckm)*m25_1x(2,-1,1,-4,3))
          msq(22,j,k)=msq(22,j,k)+
     &     sub26_1(qg)*(aveqg/aveqq)*(xn-xninv )*(
     &         +Vckm*(m26_1x(0,-1,2,-1,1)
     &                +real(nf-2,dp)*m26_1x(0,-1,4,-2,4)
     &                +0.5_dp*m26_1x(0,-1,2,-2,2))
     &    +(2._dp-Vckm)*m26_1x(0,-1,4,-1,3)
     &         +Vckm*(m26_1x(1,-1,2,-1,1)
     &                +real(nf-2,dp)*m26_1x(1,-1,4,-2,4)
     &                +0.5_dp*m26_1x(1,-1,2,-2,2))
     &    +(2._dp-Vckm)*m26_1x(1,-1,4,-1,3)
     &         +Vckm*(m26_1x(2,-1,2,-1,1)
     &                +real(nf-2,dp)*m26_1x(2,-1,4,-2,4)
     &                +0.5_dp*m26_1x(2,-1,2,-2,2))
     &    +(2._dp-Vckm)*m26_1x(2,-1,4,-1,3))
c--- 19/5/09: symmetrized 57 and 67 between _1 and _2
c--- 26/5/09: added additional 57_6 and 67_5 and divided as in Gflag gg dips
          msq( 9,j,k)=msq( 9,j,k)+1.5_dp*Vckm*half*sub57_1(gq)*(
     &     +m17_5x(0,-1,0,0,-2)+m17_5x(1,-1,0,0,-2))
     &                           -1.5_dp*Vckm*half*sub57_1v*
     ...
     &     (m57_2vg(1,-1,0)+m57_2vg(2,-1,0))
          msq( 2,j,k)=msq( 2,j,k)+1.5_dp*Vckm*half*sub57_6(gq)*(
     &     +m57_6x(0,-1,0,0,-2)+m57_6x(2,-1,0,0,-2))
     &                           -1.5_dp*Vckm*half*sub57_6v*
     &     (m57_6vg(0,-1,0)+m57_6vg(2,-1,0))
         msq(12,j,k)=msq(12,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &    sub67_1(gq)*(
     &     +m17_6x(0,-1,0,-2,0)+m17_6x(1,-1,0,-2,0))
     ...
     &            -sub67_2v*(m67_2vg(1,-1,0)+m67_2vg(2,-1,0)))
         msq( 4,j,k)=msq( 4,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &    sub67_5(gq)*(
     &     +m67_5x(0,-1,0,-2,0)+m67_5x(2,-1,0,-2,0))
...
c--- W radiated from the gluon line, all quarks
     ...
     &    +m26_1x(0,0,0,1,-2)*Vckm*0.5_dp
     &    +m26_1x(0,0,0,3,-4)*(2._dp-Vckm)
     &    +m26_1x(1,0,0,1,-2)*Vckm*0.5_dp
     &    +m26_1x(1,0,0,3,-4)*(2._dp-Vckm)
     &    +m26_1x(2,0,0,1,-2)*Vckm*0.5_dp
     &    +m26_1x(2,0,0,3,-4)*(2._dp-Vckm))
     &                          +sub26_1v*(aveqg/avegg)*(
     &    +m26_1vx(0,0,1,-2)*Vckm*0.5_dp
     ...
     &                 +m15_2x(0,-4,2,1,-4)+m15_2x(0,-3,2,1,-3)*2._dp)
     &    +(xn-xninv )*(0.5_dp*m15_2x(1,-1,2,1,-1)+m15_2x(1,-1,2,2,-2)
     &                 +m15_2x(1,-4,2,1,-4)+m15_2x(1,-3,2,1,-3)*2._dp)
     &    +(xn-xninv )*(0.5_dp*m15_2x(2,-1,2,1,-1)+m15_2x(2,-1,2,2,-2)
     &                 +m15_2x(2,-4,2,1,-4)+m15_2x(2,-3,2,1,-3)*2._dp))
     ...
     &                 +m16_2x(0,-1,2,4,-4)+m16_2x(0,-1,2,3,-3)*2._dp)
     &    +(xn-xninv )*(0.5_dp*m16_2x(1,-1,2,1,-1)+m16_2x(1,-2,2,1,-2)
     &                 +m16_2x(1,-1,2,4,-4)+m16_2x(1,-1,2,3,-3)*2._dp)
     &    +(xn-xninv )*(0.5_dp*m16_2x(2,-1,2,1,-1)+m16_2x(2,-2,2,1,-2)
     &                 +m16_2x(2,-1,2,4,-4)+m16_2x(2,-1,2,3,-3)*2._dp))
...
c--- 26/5/09: added additional 57_6 and 67_5 and divided as in Gflag gg dips
     ...
     &    +m27_6x(0,0,2,1,0)+m27_6x(2,0,2,1,0))
     &                          -1.5_dp*Vckm*half*sub67_2v*
     &    (m67_2vg(0,0,2)+m67_2vg(2,0,2))
         msq( 4,j,k)=msq( 4,j,k)+1.5_dp*Vckm*half*sub67_5(gq)*(
     &    +m67_5x(0,0,2,1,0)+m67_5x(1,0,2,1,0))
     &                          -1.5_dp*Vckm*half*sub67_5v*
     &    (m67_5vg(0,0,2)+m67_5vg(1,0,2))
         msq(22,j,k)=msq(22,j,k)+sub26_1(gq)*(aveqg/avegg)*(
     &    +Vckm*m26_1x(0,0,0,1,-2)+(2._dp-Vckm)*m26_1x(0,0,0,3,-4)
     &    +Vckm*m26_1x(1,0,0,1,-2)+(2._dp-Vckm)*m26_1x(1,0,0,3,-4)
     &    +Vckm*m26_1x(2,0,0,1,-2)+(2._dp-Vckm)*m26_1x(2,0,0,3,-4))
     &                          +sub26_1v*(aveqg/avegg)*(
     &    +Vckm*m26_1vx(0,0,1,-2)+(2._dp-Vckm)*m26_1vx(0,0,3,-4))
         endif
c------- G-Qbar
        elseif (k < 0) then
          if (kk(k) == -2) then
     ...
     &     +(xn-xninv )*(0.5_dp*m15_2x(0,2,-2,-2,1)+m15_2x(0,4,-2,-2,3))
     &     +(xn-xninv )*(0.5_dp*m15_2x(1,2,-2,-2,1)+m15_2x(1,4,-2,-2,3))
     &     +(xn-xninv )*(0.5_dp*m15_2x(2,2,-2,-2,1)+m15_2x(2,4,-2,-2,3)))
          msq(19,j,k)=msq(19,j,k)+sub16_2(qg)*(aveqg/aveqq)*(
     &     +(xn-xninv )*(0.5_dp*m16_2x(0,2,-2,-2,1)+m16_2x(0,2,-2,-4,3))
     &     +(xn-xninv )*(0.5_dp*m16_2x(1,2,-2,-2,1)+m16_2x(1,2,-2,-4,3))
     &     +(xn-xninv )*(0.5_dp*m16_2x(2,2,-2,-2,1)+m16_2x(2,2,-2,-4,3)))
          msq(22,j,k)=msq(22,j,k)+sub26_1(gq)*(aveqg/avegg)*(
     &     +Vckm*m26_1x(0,0,0,-2,1)*0.5_dp+(2._dp-Vckm)*m26_1x(0,0,0,-4,3)
     &     +Vckm*m26_1x(1,0,0,-2,1)*0.5_dp+(2._dp-Vckm)*m26_1x(1,0,0,-4,3)
     &     +Vckm*m26_1x(2,0,0,-2,1)*0.5_dp+(2._dp-Vckm)*m26_1x(2,0,0,-4,3))
     &                           +sub26_1v*(aveqg/avegg)*(
     &     +Vckm*m26_1vx(0,0,-2,1)*0.5_dp+(2._dp-Vckm)*m26_1vx(0,0,-4,3))
     ...
     &     +m17_2x(0,-4,-1,-4,-2)*Vckm*real(nf-2,dp)
     &     +m17_2x(0,-2,-1,-2,-2)*Vckm
     &     +m17_2x(0,-3,-1,-4,-1)*(2._dp-Vckm)
     &     +m17_2x(1,-1,-1,-2,-1)*Vckm
     &     +m17_2x(1,-4,-1,-4,-2)*Vckm*real(nf-2,dp)
     &     +m17_2x(1,-2,-1,-2,-2)*Vckm
     &     +m17_2x(1,-3,-1,-4,-1)*(2._dp-Vckm)
     &     +m17_2x(2,-1,-1,-2,-1)*Vckm
     &     +m17_2x(2,-4,-1,-4,-2)*Vckm*real(nf-2,dp)
     &     +m17_2x(2,-2,-1,-2,-2)*Vckm
     &     +m17_2x(2,-3,-1,-4,-1)*(2._dp-Vckm))
          msq(21,j,k)=msq(21,j,k)+
     &     sub15_2(qg)*(aveqg/aveqq)*Vckm*(
     &     +(xn-xninv )*(0.5_dp*m15_2x(0,2,-1,-2,2)+m15_2x(0,2,-1,-1,1)
     &                  +m15_2x(0,4,-1,-2,4)+m15_2x(0,3,-1,-2,3)*2._dp)
     &     +(xn-xninv )*(0.5_dp*m15_2x(1,2,-1,-2,2)+m15_2x(1,2,-1,-1,1)
     &                  +m15_2x(1,4,-1,-2,4)+m15_2x(1,3,-1,-2,3)*2._dp)
     &     +(xn-xninv )*(0.5_dp*m15_2x(2,2,-1,-2,2)+m15_2x(2,2,-1,-1,1)
     &                  +m15_2x(2,4,-1,-2,4)+m15_2x(2,3,-1,-2,3)*2._dp))
     &    +sub15_2(qg)*(aveqg/aveqq)*(2._dp-Vckm)*(xn-xninv )*(
     &                  +m15_2x(0,4,-1,-1,3)
     &                  +m15_2x(1,4,-1,-1,3)
     &                  +m15_2x(2,4,-1,-1,3))
     ...
     &                  +m16_2x(0,2,-1,-4,4)+m16_2x(0,2,-1,-3,3)*2._dp)
     &     +(xn-xninv )*(0.5_dp*m16_2x(1,2,-1,-2,2)+m16_2x(1,1,-1,-2,1)
     &                  +m16_2x(1,2,-1,-4,4)+m16_2x(1,2,-1,-3,3)*2._dp)
     &     +(xn-xninv )*(0.5_dp*m16_2x(2,2,-1,-2,2)+m16_2x(2,1,-1,-2,1)
     &                  +m16_2x(2,2,-1,-4,4)+m16_2x(2,2,-1,-3,3)*2._dp))
     &    +sub16_2(qg)*(aveqg/aveqq)*(2._dp-Vckm)*(xn-xninv )*(
     &                  +m16_2x(0,1,-1,-4,3)
     &                  +m16_2x(1,1,-1,-4,3)
     &                  +m16_2x(2,1,-1,-4,3))
          msq(22,j,k)=msq(22,j,k)+sub26_1(gq)*(aveqg/avegg)*(
     &     +m26_1x(0,0,0,-2,1)*Vckm
     &     +m26_1x(0,0,0,-4,3)*(2._dp-Vckm)
     &     +m26_1x(1,0,0,-2,1)*Vckm
     &     +m26_1x(1,0,0,-4,3)*(2._dp-Vckm)
     &     +m26_1x(2,0,0,-2,1)*Vckm
     &     +m26_1x(2,0,0,-4,3)*(2._dp-Vckm))
     &                           +sub26_1v*(aveqg/avegg)*(
     &     +m26_1vx(0,0,-2,1)*Vckm
...
c--- 26/5/09: added additional 57_6 and 67_5 and divided as in Gflag gg dips
     ...
     &    -sub57_1v*(m57_1vg(1,0,-1)+m57_1vg(2,0,-1)))
         msq(17,j,k)=msq(17,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &     sub57_2(gq)*(
     &      +m27_5x(0,0,-1,0,-2)+m27_5x(1,0,-1,0,-2))
     &    -sub57_2v*(m57_2vg(0,0,-1)+m57_2vg(1,0,-1)))
         msq( 2,j,k)=msq( 2,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &     sub57_6(gq)*(
     &      +m57_6x(0,0,-1,0,-2)+m57_6x(2,0,-1,0,-2))
     ...
     &     (m67_5vg(0,0,-1)+m67_5vg(2,0,-1))
      ...
      subroutine donothing_gvecx(p,n,in,msq,mvg,mvxg)
      implicit none
      include 'types.f'
      include 'nf.f'
      include 'mxpart.f'
