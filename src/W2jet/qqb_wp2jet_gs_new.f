...
c***********************************************************************
      subroutine qqb_wp2jet_gs_new(p,msq)
      implicit none
      include 'types.f'
c***********************************************************************
c     Authors: J.M. Campbell and R.K. Ellis                            *
c     March, 2001.                                                     *
c     (updated: May, 2009)                                             *
c***********************************************************************
...
c--- slightly obtuse notation, to simplify declaration lines
     ...
     & msq65_7(fn:nf,fn:nf),msq65_7v(fn:nf,fn:nf),
     ...
     & sub57_6(4),sub67_5(4),sub65_7(4),dsubv,dsub(4),
     & sub57_6v,sub57_1v,sub67_1v,sub67_5v,sub57_2v,sub67_2v,
     & sub26_1v,sub25_1v,sub15_2v,sub16_2v,sub65_1v,sub65_2v,sub65_7v
      real(dp)::
     ...
     &                 m65_7g(0:2,fn:nf,fn:nf),m65_7vg(0:2,fn:nf,fn:nf)
     ...
     &         qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,donothing_gvecx_new
...
c--- final-final
     ...
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,m57_6,m57_6x,mg,m57_6vg,m57_6vx)
      call dipsx_new(4,p,6,7,5,sub67_5,sub67_5v,msq67_5,msq67_5v,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,m67_5,m67_5x,mg,m67_5vg,m67_5vx)
c--- dipole added for consistency with Gflag piece
      call dipsx_new(5,p,6,5,7,sub65_7,sub65_7v,msq65_7,msq65_7v,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,mqq,msqx,m65_7g,m65_7vg,mvxg)
...
c--- sub..
     ...
     & qqb_wp2jetx_new,donothing_gvecx_new,m15_6,m15_6x,m15_6g,mvg,mvxg)
      call dipsx_new(7,p,6,5,1,sub65_1,sub65_1v,dummy,dummyv,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,mqq,msqx,m65_1g,m65_1vg,m65_1vx)

      call dipsx_new(9,p,1,7,5,sub17_5,dsubv,msq17_5,dummyv,
     & qqb_wp2jetx_new,donothing_gvecx_new,m17_5,m17_5x,mg,mvg,mvxg)
      call dipsx_new(9,p,5,7,1,sub57_1,sub57_1v,dummy,dummyv,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,mqq,msqx,m57_1g,m57_1vg,m57_1vx)

      call dipsx_new(12,p,1,7,6,sub17_6,dsubv,msq17_6,dummyv,
     & qqb_wp2jetx_new,donothing_gvecx_new,m17_6,m17_6x,mg,mvg,mvxg)
      call dipsx_new(12,p,6,7,1,sub67_1,sub67_1v,dummy,dummyv,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,mqq,msqx,m67_1g,m67_1vg,m67_1vx)

      call dipsx_new(13,p,2,7,6,sub27_6,dsubv,msq27_6,dummyv,
     & qqb_wp2jetx_new,donothing_gvecx_new,m27_6,m27_6x,mg,mvg,mvxg)
      call dipsx_new(13,p,6,7,2,sub67_2,sub67_2v,dummy,dummyv,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,mqq,msqx,mg,m67_2vg,m67_2vx)

      call dipsx_new(17,p,2,7,5,sub27_5,dsubv,msq27_5,dummyv,
     & qqb_wp2jetx_new,donothing_gvecx_new,m27_5,m27_5x,mg,mvg,mvxg)
      call dipsx_new(17,p,5,7,2,sub57_2,sub57_2v,dummy,dummyv,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,mqq,msqx,mg,m57_2vg,m57_2vx)

      call dipsx_new(18,p,2,5,6,sub25_6,dsubv,msq25_6,dummyv,
     & qqb_wp2jetx_new,donothing_gvecx_new,m25_6,m25_6x,m25_6g,mvg,mvxg)
      call dipsx_new(18,p,6,5,2,sub65_2,sub65_2v,dummy,dummyv,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,mqq,msqx,m65_2g,m65_2vg,m65_2vx)

c--- calculate all the initial-initial dipoles
      call dipsx_new(19,p,1,6,2,sub16_2,sub16_2v,msq16_2,msq16_2v,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,m16_2,m16_2x,m16_2g,m16_2vg,m16_2vx)
      call dipsx_new(20,p,1,7,2,sub17_2,dsubv,msq17_2,dummyv,
     & qqb_wp2jetx_new,donothing_gvecx_new,m17_2,m17_2x,mg,mvg,mvxg)
      call dipsx_new(21,p,1,5,2,sub15_2,sub15_2v,msq15_2,msq15_2v,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,m15_2,m15_2x,m15_2g,m15_2vg,m15_2vx)
      call dipsx_new(22,p,2,6,1,sub26_1,sub26_1v,msq26_1,msq26_1v,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,m26_1,m26_1x,m26_1g,m26_1vg,m26_1vx)
      call dipsx_new(23,p,2,7,1,sub27_1,dsubv,msq27_1,dummyv,
     & qqb_wp2jetx_new,donothing_gvecx_new,m27_1,m27_1x,mg,mvg,mvxg)
      call dipsx_new(24,p,2,5,1,sub25_1,sub25_1v,msq25_1,dummyv,
     & qqb_wp2jetx_new,qqb_wp2jet_gvecx_new,m25_1,m25_1x,m25_1g,m25_1vg,m25_1vx)
...
c---QQ
     ...
     &      m26_1x(0,pp(2,0,1,0))+m26_1x(1,pp(2,0,1,0))+m26_1x(2,pp(2,0,1,0)))
     &                        +sub26_1v*(aveqq/aveqg)*
     &     (Vsum(j)-0.5_dp*Vsq(j,-k))*m26_1vx(pp(2,0,1,0))
       msq(24,j,k)=msq(24,j,k)+
     &     0.5_dp*sub25_1(gq)*(aveqq/aveqg)*Vsq(j,-k)*(
     &      m25_1x(0,pp(2,0,1,0))+m25_1x(1,pp(2,0,1,0))+m25_1x(2,pp(2,0,1,0)))
     ...
     &      m15_2x(0,pp(0,2,1,0))+m15_2x(1,pp(0,2,1,0))+m15_2x(2,pp(0,2,1,0)))
     &                        +sub15_2v*(aveqq/aveqg)*
     &     (Vsum(k)-0.5_dp*Vsq(k,-j))*m15_2vx(pp(0,2,1,0))
       msq(19,j,k)=msq(19,j,k)
     &                      +0.5_dp*sub16_2(gq)*(aveqq/aveqg)*Vsq(k,-j)*(
     &      m16_2x(0,pp(0,2,1,0))+m16_2x(1,pp(0,2,1,0))+m16_2x(2,pp(0,2,1,0)))
     ...
     &      m15_2x(0,pp(0,4,3,0))+m15_2x(1,pp(0,4,3,0))+m15_2x(2,pp(0,4,3,0)))
...
c---QbarQbar
     ...
     & *((xn+xninv)*m27_1(0,j,k)+two*(m27_1(1,j,k)+m27_1(2,j,k))*xninv)
       ...
       msq(21,j,k)=msq(21,j,k)+sub15_2(gq)*(aveqq/aveqg)*
     &     (Vsum(k)-0.5_dp*Vsq(k,-j))*(
     &      m15_2x(0,pp(0,-1,-2,0))+m15_2x(1,pp(0,-1,-2,0))+m15_2x(2,pp(0,-1,-2,0)))
     &                        +sub15_2v*(aveqq/aveqg)*
     &     (Vsum(k)-0.5_dp*Vsq(k,-j))*m15_2vx(pp(0,-1,-2,0))
       msq(19,j,k)=msq(19,j,k)
     &                      +0.5_dp*sub16_2(gq)*(aveqq/aveqg)*Vsq(k,-j)*(
     &      m16_2x(0,pp(0,-1,-2,0))+m16_2x(1,pp(0,-1,-2,0))+m16_2x(2,pp(0,-1,-2,0)))
     &                      +0.5_dp*sub16_2v*(aveqq/aveqg)*Vsq(k,-j)*(
     &     +m16_2vx(pp(0,-1,-2,0)))
        elseif ((jj(j) == -1) .and. (kk(k) == -2)) then
       msq(22,j,k)=msq(22,j,k)+sub26_1(gq)*(aveqq/aveqg)*
     &     (Vsum(j)-0.5_dp*Vsq(j,-k))*(
     &      m26_1x(0,pp(-1,0,-2,0))+m26_1x(1,pp(-1,0,-2,0))+m26_1x(2,pp(-1,0,-2,0)))
     &                        +sub26_1v*(aveqq/aveqg)*
     &     (Vsum(j)-0.5_dp*Vsq(j,-k))*m26_1vx(pp(-1,0,-2,0))
       msq(24,j,k)=msq(24,j,k)+
     &     0.5_dp*sub25_1(gq)*(aveqq/aveqg)*Vsq(j,-k)*(
     &      m25_1x(0,pp(-1,0,-2,0))+m25_1x(1,pp(-1,0,-2,0))+m25_1x(2,pp(-1,0,-2,0)))
     &    +0.5_dp*sub25_1v*(aveqq/aveqg)*Vsq(j,-k)*(
     &     +m25_1vx(pp(-1,0,-2,0)))
     ...
     &    +m26_1vx(pp(-1,0,-2,0)))
       msq(21,j,k)=msq(21,j,k)+sub15_2(gq)*(aveqq/aveqg)*Vsum(k)*(
     &      m15_2x(0,pp(0,-3,-4,0))+m15_2x(1,pp(0,-3,-4,0))+m15_2x(2,pp(0,-3,-4,0)))
     &                        +sub15_2v*(aveqq/aveqg)*Vsum(k)*(
     &     +m15_2vx(pp(0,-3,-4,0)))
        endif
        endif
...
c--- 10/17/18: proper combination of final-initial and final-final for consistency with Gflag
         msq( 5,j,k)=msq( 5,j,k)+real(nf,dp)*sub65_7(gq)*(
     &        m65_7g(1,2,-1)+m65_7g(2,2,-1))
     &                          -real(nf,dp)*sub65_7v*(
     &        m65_7vg(1,2,-1)+m65_7vg(2,2,-1))
         msq( 7,j,k)=msq( 7,j,k)+real(nf,dp)*sub65_1(gq)*(
     &        m15_6g(0,2,-1)+m15_6g(1,2,-1))
     &                          -real(nf,dp)*sub65_1v*(
     &        m65_1vg(0,2,-1)+m65_1vg(1,2,-1))
         msq(18,j,k)=msq(18,j,k)+real(nf,dp)*sub65_2(gq)*(
     &        m25_6g(0,2,-1)+m25_6g(2,2,-1))
     &                          -real(nf,dp)*sub65_2v*(
     &        m65_2vg(0,2,-1)+m65_2vg(2,2,-1))
         endif
        elseif ((jj(j)==2) .and. (kk(k)==-2)) then
       msq(22,j,k)=msq(22,j,k)+sub26_1(gq)*(aveqq/aveqg)*Vsum(j)*(
     &      m26_1x(0,pp(2,0,1,0))+m26_1x(1,pp(2,0,1,0))+m26_1x(2,pp(2,0,1,0)))
...
c--- 10/17/18: proper combination of final-initial and final-final for consistency with Gflag
         msq( 5,j,k)=msq( 5,j,k)+real(nf,dp)*sub65_7(gq)*(
     &        m65_7g(1,-1,2)+m65_7g(2,-1,2))
     &                          -real(nf,dp)*sub65_7v*(
     &        m65_7vg(1,-1,2)+m65_7vg(2,-1,2))
         msq( 7,j,k)=msq( 7,j,k)+real(nf,dp)*sub65_1(gq)*(
     &        m15_6g(0,-1,2)+m15_6g(2,-1,2))
     &                          -real(nf,dp)*sub65_1v*(
     &        m65_1vg(0,-1,2)+m65_1vg(2,-1,2))
         msq(18,j,k)=msq(18,j,k)+real(nf,dp)*sub65_2(gq)*(
     &        m25_6g(0,-1,2)+m25_6g(1,-1,2))
     &                          -real(nf,dp)*sub65_2v*(
     &        m65_2vg(0,-1,2)+m65_2vg(1,-1,2))
         endif
        elseif ((jj(j)==-2) .and. (kk(k)==2)) then
       msq(19,j,k)=msq(19,j,k)+sub16_2(gq)*(aveqq/aveqg)*Vsum(k)*(
     &      m16_2x(0,pp(0,2,1,0))+m16_2x(1,pp(0,2,1,0))+m16_2x(2,pp(0,2,1,0)))
...
c------- Q-G
     ...
     &     +(xn-xninv )*(0.5_dp*m25_1x(0,pp(1,-1,1,-2))*Vckm
     &                        +m25_1x(0,pp(1,-1,3,-4))*(2._dp-Vckm))
     &     +(xn-xninv )*(0.5_dp*m25_1x(1,pp(1,-1,1,-2))*Vckm
     &                        +m25_1x(1,pp(1,-1,3,-4))*(2._dp-Vckm))
     &     +(xn-xninv )*(0.5_dp*m25_1x(2,pp(1,-1,1,-2))*Vckm
     &                        +m25_1x(2,pp(1,-1,3,-4))*(2._dp-Vckm)))
          msq(22,j,k)=msq(22,j,k)+sub26_1(qg)*(aveqg/aveqq)*(
     &     +(xn-xninv )*(0.5_dp*m26_1x(0,pp(1,-1,1,-2))*Vckm
     &                        +m26_1x(0,pp(1,-3,1,-4))*(2._dp-Vckm))
     &     +(xn-xninv )*(0.5_dp*m26_1x(1,pp(1,-1,1,-2))*Vckm
     &                        +m26_1x(1,pp(1,-3,1,-4))*(2._dp-Vckm))
     &     +(xn-xninv )*(0.5_dp*m26_1x(2,pp(1,-1,1,-2))*Vckm
     &                        +m26_1x(2,pp(1,-3,1,-4))*(2._dp-Vckm)))
c--- W radiated from the gluon line, identical quarks only
          msq(19,j,k)=msq(19,j,k)+0.5_dp*Vckm*sub16_2(gq)*(aveqg/avegg)*(
     &     +m16_2x(0,pp(0,0,1,-2))+m16_2x(1,pp(0,0,1,-2))+m16_2x(2,pp(0,0,1,-2)))
...
c--- W radiated from the gluon line, all quarks
     ...
     &     +m15_2x(0,pp(0,0,1,-2))+m15_2x(1,pp(0,0,1,-2))+m15_2x(2,pp(0,0,1,-2)))
     ...
     &     +m15_2vx(pp(0,0,1,-2)))
          ...
          Vckm=Vsq(j,-j+1)
          msq(23,j,k)=msq(23,j,k)+sub27_1(qg)*(aveqg/aveqq)*(
     &     +(xn-xninv )*(  m27_1x(0,pp(+2,+1,+1,+1))+m27_1x(0,pp(+2,+2,+2,+1))
     &       +real(nf-2,dp)*m27_1x(0,pp(+2,+3,+1,+3))+m27_1x(0,pp(+2,+4,+2,+3)))
     &     +(xn-xninv )*(  m27_1x(1,pp(+2,+1,+1,+1))+m27_1x(1,pp(+2,+2,+2,+1))
     &       +real(nf-2,dp)*m27_1x(1,pp(+2,+3,+1,+3))+m27_1x(1,pp(+2,+4,+2,+3)))
     &     +(xn-xninv )*(  m27_1x(2,pp(+2,+1,+1,+1))+m27_1x(2,pp(+2,+2,+2,+1))
     &      +real(nf-2,dp)*m27_1x(2,pp(+2,+3,+1,+3))+m27_1x(2,pp(+2,+4,+2,+3))))
          msq(24,j,k)=msq(24,j,k)+sub25_1(qg)*(aveqg/aveqq)*Vckm*(
     &     +(xn-xninv )*(m25_1x(0,pp(2,-2,1,-2))+0.5_dp*m25_1x(0,pp(2,-1,1,-1))
     &                  +m25_1x(0,pp(2,-1,4,-4))+m25_1x(0,pp(2,-1,3,-3))*2._dp
     &                  +m25_1x(0,pp(2,-2,3,-4)))
     &     +(xn-xninv )*(m25_1x(1,pp(2,-2,1,-2))+0.5_dp*m25_1x(1,pp(2,-1,1,-1))
     &                  +m25_1x(1,pp(2,-1,4,-4))+m25_1x(1,pp(2,-1,3,-3))*2._dp
     &                  +m25_1x(1,pp(2,-2,3,-4)))
     &     +(xn-xninv )*(m25_1x(2,pp(2,-2,1,-2))+0.5_dp*m25_1x(2,pp(2,-1,1,-1))
     &                  +m25_1x(2,pp(2,-1,4,-4))+m25_1x(2,pp(2,-1,3,-3))*2._dp
     &                  +m25_1x(2,pp(2,-2,3,-4))))
          msq(22,j,k)=msq(22,j,k)+sub26_1(qg)*(aveqg/aveqq)*Vckm*(
     &     +(xn-xninv )*(m26_1x(0,pp(2,-1,2,-2))+0.5_dp*m26_1x(0,pp(2,-1,1,-1))
     &                  +m26_1x(0,pp(2,-4,1,-4))+m26_1x(0,pp(2,-3,1,-3))*2._dp
     &                  +m26_1x(0,pp(2,-3,2,-4)))
     &     +(xn-xninv )*(m26_1x(1,pp(2,-1,2,-2))+0.5_dp*m26_1x(1,pp(2,-1,1,-1))
     &                  +m26_1x(1,pp(2,-4,1,-4))+m26_1x(1,pp(2,-3,1,-3))*2._dp
     &                  +m26_1x(1,pp(2,-3,2,-4)))
     &     +(xn-xninv )*(m26_1x(2,pp(2,-1,2,-2))+0.5_dp*m26_1x(2,pp(2,-1,1,-1))
     &                  +m26_1x(2,pp(2,-4,1,-4))+m26_1x(2,pp(2,-3,1,-3))*2._dp
     &                  +m26_1x(2,pp(2,-3,2,-4))))
c--- 17/5/09: symmetrized 57 and 67 between _1 and _2
c--- 26/5/09: added additional 57_6 and 67_5 and divided as in Gflag gg dips
          msq( 9,j,k)=msq( 9,j,k)+1.5_dp*Vckm*half*sub57_1(gq)*(
     &     +m17_5x(0,pp(2,0,0,1))+m17_5x(2,pp(2,0,0,1)))
     &                           -1.5_dp*Vckm*half*sub57_1v*
     &     (m57_1vg(0,2,0)+m57_1vg(2,2,0))
          msq(17,j,k)=msq(17,j,k)+1.5_dp*Vckm*half*sub57_2(gq)*(
     &     +m27_5x(1,pp(2,0,0,1))+m27_5x(2,pp(2,0,0,1)))
     &                           -1.5_dp*Vckm*half*sub57_2v*
     &     (m57_2vg(1,2,0)+m57_2vg(2,2,0))
          msq( 2,j,k)=msq( 2,j,k)+1.5_dp*Vckm*half*sub57_6(gq)*(
     &     +m57_6x(0,pp(2,0,0,1))+m57_6x(1,pp(2,0,0,1)))
     &                           -1.5_dp*Vckm*half*sub57_6v*
     &     (m57_6vg(0,2,0)+m57_6vg(1,2,0))
          msq(12,j,k)=msq(12,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &      sub67_1(gq)*(
     &         +m17_6x(0,pp(2,0,1,0))+m17_6x(2,pp(2,0,1,0)))
     &     -sub67_1v*(m67_1vg(0,2,0)+m67_1vg(2,2,0)))
          msq(13,j,k)=msq(13,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &      sub67_2(gq)*(
     &         +m27_6x(1,pp(2,0,1,0))+m27_6x(2,pp(2,0,1,0)))
     &     -sub67_2v*(m67_2vg(1,2,0)+m67_2vg(2,2,0)))
          msq( 4,j,k)=msq( 4,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &      sub67_5(gq)*(
     &         +m67_5x(0,pp(2,0,1,0))+m67_5x(1,pp(2,0,1,0)))
     &     -sub67_5v*(m67_5vg(0,2,0)+m67_5vg(1,2,0)))
          msq(21,j,k)=msq(21,j,k)+sub15_2(gq)*2._dp*(aveqg/avegg)*(
     &     +m15_2x(0,pp(0,0,3,-4))+m15_2x(1,pp(0,0,3,-4))+m15_2x(2,pp(0,0,3,-4)))
     &                           +sub15_2v*2._dp*(aveqg/avegg)*(
     &     +m15_2vx(pp(0,0,3,-4)))
          endif
...
c------- Qbar-G
     ...
     &                  +m27_1(2,j,-4)+m27_1(2,j,-5)))
          msq(24,j,k)=msq(24,j,k)+sub25_1(qg)*(aveqg/aveqq)*(
     &     +(xn-xninv )*(0.5_dp*m25_1x(0,pp(-2,2,-2,1))+m25_1x(0,pp(-2,2,-4,3)))
     &     +(xn-xninv )*(0.5_dp*m25_1x(1,pp(-2,2,-2,1))+m25_1x(1,pp(-2,2,-4,3)))
     &     +(xn-xninv )*(0.5_dp*m25_1x(2,pp(-2,2,-2,1))+m25_1x(2,pp(-2,2,-4,3))))
          msq(22,j,k)=msq(22,j,k)+sub26_1(qg)*(aveqg/aveqq)*(
     &     +(xn-xninv )*(0.5_dp*m26_1x(0,pp(-2,2,-2,1))+m26_1x(0,pp(-2,4,-2,3)))
     &     +(xn-xninv )*(0.5_dp*m26_1x(1,pp(-2,2,-2,1))+m26_1x(1,pp(-2,4,-2,3)))
     &     +(xn-xninv )*(0.5_dp*m26_1x(2,pp(-2,2,-2,1))+m26_1x(2,pp(-2,4,-2,3))))
          msq(19,j,k)=msq(19,j,k)+0.5_dp*sub16_2(gq)*(aveqg/avegg)*(
     &     +m16_2x(0,pp(0,0,-2,1))+m16_2x(1,pp(0,0,-2,1))+m16_2x(2,pp(0,0,-2,1)))
     &                           +0.5_dp*sub16_2v*(aveqg/avegg)*(
     &     +m16_2vx(pp(0,0,-2,1)))
          msq(21,j,k)=msq(21,j,k)
     &               +(2._dp-0.5_dp*Vckm)*sub15_2(gq)*(aveqg/avegg)*(
     &     +m15_2x(0,pp(0,0,-2,1))+m15_2x(1,pp(0,0,-2,1))+m15_2x(2,pp(0,0,-2,1)))
     ...
     &     +m27_1x(0,pp(-1,-1,-1,-2))*Vckm
     &     +m27_1x(0,pp(-1,-4,-2,-4))*Vckm*real(nf-2,dp)
     &     +m27_1x(0,pp(-1,-2,-2,-2))*Vckm
     &     +m27_1x(0,pp(-1,-3,-1,-4))*(2._dp-Vckm)
     &     +m27_1x(1,pp(-1,-1,-1,-2))*Vckm
     &     +m27_1x(1,pp(-1,-4,-2,-4))*Vckm*real(nf-2,dp)
     &     +m27_1x(1,pp(-1,-2,-2,-2))*Vckm
     &     +m27_1x(1,pp(-1,-3,-1,-4))*(2._dp-Vckm)
     &     +m27_1x(2,pp(-1,-1,-1,-2))*Vckm
     &     +m27_1x(2,pp(-1,-4,-2,-4))*Vckm*real(nf-2,dp)
     &     +m27_1x(2,pp(-1,-2,-2,-2))*Vckm
     &     +m27_1x(2,pp(-1,-3,-1,-4))*(2._dp-Vckm))
          msq(24,j,k)=msq(24,j,k)+
     &     sub25_1(qg)*(aveqg/aveqq)*(xn-xninv )*(
     &         +Vckm*(m25_1x(0,pp(-1,1,-2,1))
     &                +real(nf-2,dp)*m25_1x(0,pp(-1,2,-4,4))
     &                +0.5_dp*m25_1x(0,pp(-1,2,-2,2)))
     &    +(2._dp-Vckm)*m25_1x(0,pp(-1,1,-4,3))
     &         +Vckm*(m25_1x(1,pp(-1,1,-2,1))
     &                +real(nf-2,dp)*m25_1x(1,pp(-1,2,-4,4))
     &                +0.5_dp*m25_1x(1,pp(-1,2,-2,2)))
     &    +(2._dp-Vckm)*m25_1x(1,pp(-1,1,-4,3))
     &         +Vckm*(m25_1x(2,pp(-1,1,-2,1))
     &                +real(nf-2,dp)*m25_1x(2,pp(-1,2,-4,4))
     &                +0.5_dp*m25_1x(2,pp(-1,2,-2,2)))
     &    +(2._dp-Vckm)*m25_1x(2,pp(-1,1,-4,3)))
          msq(22,j,k)=msq(22,j,k)+
     &     sub26_1(qg)*(aveqg/aveqq)*(xn-xninv )*(
     &         +Vckm*(m26_1x(0,pp(-1,2,-1,1))
     &                +real(nf-2,dp)*m26_1x(0,pp(-1,4,-2,4))
     &                +0.5_dp*m26_1x(0,pp(-1,2,-2,2)))
     &    +(2._dp-Vckm)*m26_1x(0,pp(-1,4,-1,3))
     &         +Vckm*(m26_1x(1,pp(-1,2,-1,1))
     &                +real(nf-2,dp)*m26_1x(1,pp(-1,4,-2,4))
     &                +0.5_dp*m26_1x(1,pp(-1,2,-2,2)))
     &    +(2._dp-Vckm)*m26_1x(1,pp(-1,4,-1,3))
     &         +Vckm*(m26_1x(2,pp(-1,2,-1,1))
     &                +real(nf-2,dp)*m26_1x(2,pp(-1,4,-2,4))
     &                +0.5_dp*m26_1x(2,pp(-1,2,-2,2)))
     &    +(2._dp-Vckm)*m26_1x(2,pp(-1,4,-1,3)))
c--- 19/5/09: symmetrized 57 and 67 between _1 and _2
c--- 26/5/09: added additional 57_6 and 67_5 and divided as in Gflag gg dips
          msq( 9,j,k)=msq( 9,j,k)+1.5_dp*Vckm*half*sub57_1(gq)*(
     &     +m17_5x(0,pp(-1,0,0,-2))+m17_5x(1,pp(-1,0,0,-2)))
     &                           -1.5_dp*Vckm*half*sub57_1v*
     &     (m57_1vg(0,-1,0)+m57_1vg(1,-1,0))
          msq(17,j,k)=msq(17,j,k)+1.5_dp*Vckm*half*sub57_2(gq)*(
     &     +m27_5x(1,pp(-1,0,0,-2))+m27_5x(2,pp(-1,0,0,-2)))
     &                           -1.5_dp*Vckm*half*sub57_2v*
     &     (m57_2vg(1,-1,0)+m57_2vg(2,-1,0))
          msq( 2,j,k)=msq( 2,j,k)+1.5_dp*Vckm*half*sub57_6(gq)*(
     &     +m57_6x(0,pp(-1,0,0,-2))+m57_6x(2,pp(-1,0,0,-2)))
     &                           -1.5_dp*Vckm*half*sub57_6v*
     &     (m57_6vg(0,-1,0)+m57_6vg(2,-1,0))
         msq(12,j,k)=msq(12,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &    sub67_1(gq)*(
     &     +m17_6x(0,pp(-1,0,-2,0))+m17_6x(1,pp(-1,0,-2,0)))
     &            -sub67_1v*(m67_1vg(0,-1,0)+m67_1vg(1,-1,0)))
         msq(13,j,k)=msq(13,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &    sub67_2(gq)*(
     &     +m27_6x(1,pp(-1,0,-2,0))+m27_6x(2,pp(-1,0,-2,0)))
     &            -sub67_2v*(m67_2vg(1,-1,0)+m67_2vg(2,-1,0)))
         msq( 4,j,k)=msq( 4,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &    sub67_5(gq)*(
     &     +m67_5x(0,pp(-1,0,-2,0))+m67_5x(2,pp(-1,0,-2,0)))
     &            -sub67_5v*(m67_5vg(0,-1,0)+m67_5vg(2,-1,0)))
          msq(21,j,k)=msq(21,j,k)+
     &     sub15_2(gq)*(aveqg/avegg)*2._dp*(
     &     +m15_2x(0,pp(0,0,-4,3))+m15_2x(1,pp(0,0,-4,3))+m15_2x(2,pp(0,0,-4,3)))
...
c------ G-Q
     ...
     &    +(0.5_dp*m15_2x(0,pp(-1,1,1,-2))*Vckm
     &           +m15_2x(0,pp(-3,1,1,-4))*(2._dp-Vckm))
     &    +(0.5_dp*m15_2x(1,pp(-1,1,1,-2))*Vckm
     &           +m15_2x(1,pp(-3,1,1,-4))*(2._dp-Vckm))
     &    +(0.5_dp*m15_2x(2,pp(-1,1,1,-2))*Vckm
     &           +m15_2x(2,pp(-3,1,1,-4))*(2._dp-Vckm)))
         msq(19,j,k)=msq(19,j,k)+sub16_2(qg)*(aveqg/aveqq)*(xn-xninv)*(
     &    +(0.5_dp*m16_2x(0,pp(-1,1,1,-2))*Vckm
     &           +m16_2x(0,pp(-1,1,3,-4))*(2._dp-Vckm))
     &    +(0.5_dp*m16_2x(1,pp(-1,1,1,-2))*Vckm
     &           +m16_2x(1,pp(-1,1,3,-4))*(2._dp-Vckm))
     &    +(0.5_dp*m16_2x(2,pp(-1,1,1,-2))*Vckm
     &           +m16_2x(2,pp(-1,1,3,-4))*(2._dp-Vckm)))
c--- W radiated from the gluon line, identical quarks only
         msq(24,j,k)=msq(24,j,k)+
     &    0.5_dp*Vckm*sub25_1(gq)*(aveqg/avegg)*(
     &    +m25_1x(0,pp(0,0,1,-2))+m25_1x(1,pp(0,0,1,-2))+m25_1x(2,pp(0,0,1,-2)))
     &    +0.5_dp*Vckm*sub25_1v*(aveqg/avegg)*(
     &    +m25_1vx(pp(0,0,1,-2)))
c--- W radiated from the gluon line, all quarks
         msq(22,j,k)=msq(22,j,k)+sub26_1(gq)*(aveqg/avegg)*(
     &    +m26_1x(0,pp(0,0,1,-2))*Vckm*0.5_dp
     &    +m26_1x(0,pp(0,0,3,-4))*(2._dp-Vckm)
     &    +m26_1x(1,pp(0,0,1,-2))*Vckm*0.5_dp
     &    +m26_1x(1,pp(0,0,3,-4))*(2._dp-Vckm)
     &    +m26_1x(2,pp(0,0,1,-2))*Vckm*0.5_dp
     &    +m26_1x(2,pp(0,0,3,-4))*(2._dp-Vckm))
     &                          +sub26_1v*(aveqg/avegg)*(
     &    +m26_1vx(pp(0,0,1,-2))*Vckm*0.5_dp
     &    +m26_1vx(pp(0,0,3,-4))*(2._dp-Vckm))
         endif
         if (kk(k) == 2) then
         Vckm=Vsq(k,-k+1)
         msq(21,j,k)=msq(21,j,k)+sub15_2(qg)*(aveqg/aveqq)*Vckm*(
     &    +(xn-xninv )*(0.5_dp*m15_2x(0,pp(-1,2,1,-1))+m15_2x(0,pp(-1,2,2,-2))
     &                 +m15_2x(0,pp(-4,2,1,-4))+m15_2x(0,pp(-3,2,1,-3))*2._dp)
     &    +(xn-xninv )*(0.5_dp*m15_2x(1,pp(-1,2,1,-1))+m15_2x(1,pp(-1,2,2,-2))
     &                 +m15_2x(1,pp(-4,2,1,-4))+m15_2x(1,pp(-3,2,1,-3))*2._dp)
     &    +(xn-xninv )*(0.5_dp*m15_2x(2,pp(-1,2,1,-1))+m15_2x(2,pp(-1,2,2,-2))
     &                 +m15_2x(2,pp(-4,2,1,-4))+m15_2x(2,pp(-3,2,1,-3))*2._dp))
     &    +sub15_2(qg)*(aveqg/aveqq)*(2._dp-Vckm)*(xn-xninv )*(
     &                 +m15_2x(0,pp(-3,2,2,-4))
     &                 +m15_2x(1,pp(-3,2,2,-4))
     &                 +m15_2x(2,pp(-3,2,2,-4)))
         msq(19,j,k)=msq(19,j,k)+sub16_2(qg)*(aveqg/aveqq)*Vckm*(
     &    +(xn-xninv )*(0.5_dp*m16_2x(0,pp(-1,2,1,-1))+m16_2x(0,pp(-2,2,1,-2))
     &                 +m16_2x(0,pp(-1,2,4,-4))+m16_2x(0,pp(-1,2,3,-3))*2._dp)
     &    +(xn-xninv )*(0.5_dp*m16_2x(1,pp(-1,2,1,-1))+m16_2x(1,pp(-2,2,1,-2))
     &                 +m16_2x(1,pp(-1,2,4,-4))+m16_2x(1,pp(-1,2,3,-3))*2._dp)
     &    +(xn-xninv )*(0.5_dp*m16_2x(2,pp(-1,2,1,-1))+m16_2x(2,pp(-2,2,1,-2))
     &                 +m16_2x(2,pp(-1,2,4,-4))+m16_2x(2,pp(-1,2,3,-3))*2._dp))
...
c--- 26/5/09: added additional 57_6 and 67_5 and divided as in Gflag gg dips
     ...
     &     sub57_1(gq)*(
     &        +m17_5x(1,pp(0,2,0,1))+m17_5x(2,pp(0,2,0,1)))
     &    -sub57_1v*(m57_1vg(1,0,2)+m57_1vg(2,0,2)))
         msq(17,j,k)=msq(17,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &     sub57_2(gq)*(
     &        +m27_5x(0,pp(0,2,0,1))+m27_5x(2,pp(0,2,0,1)))
     &    -sub57_2v*(m57_2vg(0,0,2)+m57_2vg(2,0,2)))
         msq( 2,j,k)=msq( 2,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &     sub57_6(gq)*(
     &        +m57_6x(0,pp(0,2,0,1))+m57_6x(1,pp(0,2,0,1)))
     &    -sub57_6v*(m57_6vg(0,0,2)+m57_6vg(1,0,2)))
         msq(12,j,k)=msq(12,j,k)+1.5_dp*Vckm*half*sub67_1(gq)*(
     &    +m17_6x(1,pp(0,2,1,0))+m17_6x(2,pp(0,2,1,0)))
     &                          -1.5_dp*Vckm*half*sub67_1v*
     &    (m67_1vg(1,0,2)+m67_1vg(2,0,2))
         msq(13,j,k)=msq(13,j,k)+1.5_dp*Vckm*half*sub67_2(gq)*(
     &    +m27_6x(0,pp(0,2,1,0))+m27_6x(2,pp(0,2,1,0)))
     &                          -1.5_dp*Vckm*half*sub67_2v*
     &    (m67_2vg(0,0,2)+m67_2vg(2,0,2))
         msq( 4,j,k)=msq( 4,j,k)+1.5_dp*Vckm*half*sub67_5(gq)*(
     &    +m67_5x(0,pp(0,2,1,0))+m67_5x(1,pp(0,2,1,0)))
     &                          -1.5_dp*Vckm*half*sub67_5v*
     &    (m67_5vg(0,0,2)+m67_5vg(1,0,2))
         msq(22,j,k)=msq(22,j,k)+sub26_1(gq)*(aveqg/avegg)*(
     &    +Vckm*m26_1x(0,pp(0,0,1,-2))+(2._dp-Vckm)*m26_1x(0,pp(0,0,3,-4))
     &    +Vckm*m26_1x(1,pp(0,0,1,-2))+(2._dp-Vckm)*m26_1x(1,pp(0,0,3,-4))
     &    +Vckm*m26_1x(2,pp(0,0,1,-2))+(2._dp-Vckm)*m26_1x(2,pp(0,0,3,-4)))
     &                          +sub26_1v*(aveqg/avegg)*(
     &    +Vckm*m26_1vx(pp(0,0,1,-2))+(2._dp-Vckm)*m26_1vx(pp(0,0,3,-4)))
         endif
c------- G-Qbar
        elseif (k < 0) then
          if (kk(k) == -2) then
     ...
     &     +(xn-xninv )*(0.5_dp*m15_2x(0,pp(2,-2,-2,1))+m15_2x(0,pp(4,-2,-2,3)))
     &     +(xn-xninv )*(0.5_dp*m15_2x(1,pp(2,-2,-2,1))+m15_2x(1,pp(4,-2,-2,3)))
     &     +(xn-xninv )*(0.5_dp*m15_2x(2,pp(2,-2,-2,1))+m15_2x(2,pp(4,-2,-2,3))))
          msq(19,j,k)=msq(19,j,k)+sub16_2(qg)*(aveqg/aveqq)*(
     &     +(xn-xninv )*(0.5_dp*m16_2x(0,pp(2,-2,-2,1))+m16_2x(0,pp(2,-2,-4,3)))
     &     +(xn-xninv )*(0.5_dp*m16_2x(1,pp(2,-2,-2,1))+m16_2x(1,pp(2,-2,-4,3)))
     &     +(xn-xninv )*(0.5_dp*m16_2x(2,pp(2,-2,-2,1))+m16_2x(2,pp(2,-2,-4,3))))
          msq(22,j,k)=msq(22,j,k)+sub26_1(gq)*(aveqg/avegg)*(
     &     +Vckm*m26_1x(0,pp(0,0,-2,1))*0.5_dp+(2._dp-Vckm)*m26_1x(0,pp(0,0,-4,3))
     &     +Vckm*m26_1x(1,pp(0,0,-2,1))*0.5_dp+(2._dp-Vckm)*m26_1x(1,pp(0,0,-4,3))
     &     +Vckm*m26_1x(2,pp(0,0,-2,1))*0.5_dp+(2._dp-Vckm)*m26_1x(2,pp(0,0,-4,3)))
     &                           +sub26_1v*(aveqg/avegg)*(
     &     +Vckm*m26_1vx(pp(0,0,-2,1))*0.5_dp+(2._dp-Vckm)*m26_1vx(pp(0,0,-4,3)))
          msq(24,j,k)=msq(24,j,k)+0.5_dp*Vckm*sub25_1(gq)*(aveqg/avegg)*(
     &     +m25_1x(0,pp(0,0,-2,1))+m25_1x(1,pp(0,0,-2,1))+m25_1x(2,pp(0,0,-2,1)))
     &                           +0.5_dp*Vckm*sub25_1v*(aveqg/avegg)*(
     &     +m25_1vx(pp(0,0,-2,1)))
          endif
          if (kk(k) == -1) then
     ...
     &     +m17_2x(0,pp(-1,-1,-2,-1))*Vckm
     &     +m17_2x(0,pp(-4,-1,-4,-2))*Vckm*real(nf-2,dp)
     &     +m17_2x(0,pp(-2,-1,-2,-2))*Vckm
     &     +m17_2x(0,pp(-3,-1,-4,-1))*(2._dp-Vckm)
     &     +m17_2x(1,pp(-1,-1,-2,-1))*Vckm
     &     +m17_2x(1,pp(-4,-1,-4,-2))*Vckm*real(nf-2,dp)
     &     +m17_2x(1,pp(-2,-1,-2,-2))*Vckm
     &     +m17_2x(1,pp(-3,-1,-4,-1))*(2._dp-Vckm)
     &     +m17_2x(2,pp(-1,-1,-2,-1))*Vckm
     &     +m17_2x(2,pp(-4,-1,-4,-2))*Vckm*real(nf-2,dp)
     &     +m17_2x(2,pp(-2,-1,-2,-2))*Vckm
     &     +m17_2x(2,pp(-3,-1,-4,-1))*(2._dp-Vckm))
          msq(21,j,k)=msq(21,j,k)+
     &     sub15_2(qg)*(aveqg/aveqq)*Vckm*(
     &     +(xn-xninv )*(0.5_dp*m15_2x(0,pp(2,-1,-2,2))+m15_2x(0,pp(2,-1,-1,1))
     &                  +m15_2x(0,pp(4,-1,-2,4))+m15_2x(0,pp(3,-1,-2,3))*2._dp)
     &     +(xn-xninv )*(0.5_dp*m15_2x(1,pp(2,-1,-2,2))+m15_2x(1,pp(2,-1,-1,1))
     &                  +m15_2x(1,pp(4,-1,-2,4))+m15_2x(1,pp(3,-1,-2,3))*2._dp)
     &     +(xn-xninv )*(0.5_dp*m15_2x(2,pp(2,-1,-2,2))+m15_2x(2,pp(2,-1,-1,1))
     &                  +m15_2x(2,pp(4,-1,-2,4))+m15_2x(2,pp(3,-1,-2,3))*2._dp))
     &    +sub15_2(qg)*(aveqg/aveqq)*(2._dp-Vckm)*(xn-xninv )*(
     &                  +m15_2x(0,pp(4,-1,-1,3))
     &                  +m15_2x(1,pp(4,-1,-1,3))
     &                  +m15_2x(2,pp(4,-1,-1,3)))
     ...
     &     +(xn-xninv )*(0.5_dp*m16_2x(0,pp(2,-1,-2,2))+m16_2x(0,pp(1,-1,-2,1))
     &                  +m16_2x(0,pp(2,-1,-4,4))+m16_2x(0,pp(2,-1,-3,3))*2._dp)
     &     +(xn-xninv )*(0.5_dp*m16_2x(1,pp(2,-1,-2,2))+m16_2x(1,pp(1,-1,-2,1))
     &                  +m16_2x(1,pp(2,-1,-4,4))+m16_2x(1,pp(2,-1,-3,3))*2._dp)
     &     +(xn-xninv )*(0.5_dp*m16_2x(2,pp(2,-1,-2,2))+m16_2x(2,pp(1,-1,-2,1))
     &                  +m16_2x(2,pp(2,-1,-4,4))+m16_2x(2,pp(2,-1,-3,3))*2._dp))
     &    +sub16_2(qg)*(aveqg/aveqq)*(2._dp-Vckm)*(xn-xninv )*(
     &                  +m16_2x(0,pp(1,-1,-4,3))
     &                  +m16_2x(1,pp(1,-1,-4,3))
     &                  +m16_2x(2,pp(1,-1,-4,3)))
          msq(22,j,k)=msq(22,j,k)+sub26_1(gq)*(aveqg/avegg)*(
     &     +m26_1x(0,pp(0,0,-2,1))*Vckm
     &     +m26_1x(0,pp(0,0,-4,3))*(2._dp-Vckm)
     &     +m26_1x(1,pp(0,0,-2,1))*Vckm
     &     +m26_1x(1,pp(0,0,-4,3))*(2._dp-Vckm)
     &     +m26_1x(2,pp(0,0,-2,1))*Vckm
     &     +m26_1x(2,pp(0,0,-4,3))*(2._dp-Vckm))
     &                           +sub26_1v*(aveqg/avegg)*(
     &     +m26_1vx(pp(0,0,-2,1))*Vckm
     &     +m26_1vx(pp(0,0,-4,3))*(2._dp-Vckm))
c--- 19/5/09: symmetrized 57 and 67 between _1 and _2
c--- 26/5/09: added additional 57_6 and 67_5 and divided as in Gflag gg dips
         msq( 9,j,k)=msq( 9,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &     sub57_1(gq)*(
     &      +m17_5x(1,pp(0,-1,0,-2))+m17_5x(2,pp(0,-1,0,-2)))
     &    -sub57_1v*(m57_1vg(1,0,-1)+m57_1vg(2,0,-1)))
         msq(17,j,k)=msq(17,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &     sub57_2(gq)*(
     &      +m27_5x(0,pp(0,-1,0,-2))+m27_5x(1,pp(0,-1,0,-2)))
     &    -sub57_2v*(m57_2vg(0,0,-1)+m57_2vg(1,0,-1)))
         msq( 2,j,k)=msq( 2,j,k)+(real(nf-2,dp)+0.5_dp)*Vckm*half*(
     &     sub57_6(gq)*(
     &      +m57_6x(0,pp(0,-1,0,-2))+m57_6x(2,pp(0,-1,0,-2)))
     &    -sub57_6v*(m57_6vg(0,0,-1)+m57_6vg(2,0,-1)))
         msq(12,j,k)=msq(12,j,k)+1.5_dp*sub67_1(gq)*Vckm*half*(
     &     +m17_6x(1,pp(0,-1,-2,0))+m17_6x(2,pp(0,-1,-2,0)))
     &                           -1.5_dp*sub67_1v*Vckm*half*
     &     (m67_1vg(1,0,-1)+m67_1vg(2,0,-1))
         msq(13,j,k)=msq(13,j,k)+1.5_dp*sub67_2(gq)*Vckm*half*(
     &     +m27_6x(0,pp(0,-1,-2,0))+m27_6x(1,pp(0,-1,-2,0)))
     &                           -1.5_dp*sub67_2v*Vckm*half*
     &     (m67_2vg(0,0,-1)+m67_2vg(1,0,-1))
         msq( 4,j,k)=msq( 4,j,k)+1.5_dp*sub67_5(gq)*Vckm*half*(
     &     +m67_5x(0,pp(0,-1,-2,0))+m67_5x(2,pp(0,-1,-2,0)))
     &                           -1.5_dp*sub67_5v*Vckm*half*
     &     (m67_5vg(0,0,-1)+m67_5vg(2,0,-1))
          endif
        endif
