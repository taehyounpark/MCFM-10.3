...
!
      subroutine AWWjetsr(j1,j2,j3,j4,j5,j6,j7,Qid,Alomp,Alomm,Alopp,Alopm,A7vmp,A7vmm,A7vpp,A7vpm)
      implicit none
      include 'types.f'
      include 'constants.f'
      include 'mxpart.f'
      ...
      include 'scheme.f'
      include 'b0.f'
      integer j1,j2,j5,j6,j4,j3,j7,Qid
...
c--- get the right sign of Alo for the renormalization below
      verbose=.false.
      call AWWjetsr_amps('mp',.false.,j1,j2,j3,j4,j5,j6,j7,Qid,1,za,zb,.false.,Alomp,A7b_lc,A7b_slc)
      A7vmp=A7b_lc*zlc+A7b_slc*zslc
      call AWWjetsr_amps('mm',.true.,j2,j1,j5,j6,j3,j4,j7,Qid,1,zb,za,.true.,Alomm,A7b_lc,A7b_slc)
      A7vmm=A7b_lc*zlc+A7b_slc*zslc
      call AWWjetsr_amps('pp',.true.,j2,j1,j3,j4,j5,j6,j7,Qid,2,za,zb,.false.,Alopp,A7b_lc,A7b_slc)
      A7vpp=A7b_lc*zlc+A7b_slc*zslc
      call AWWjetsr_amps('pm',.false.,j1,j2,j5,j6,j3,j4,j7,Qid,2,zb,za,.true.,Alopm,A7b_lc,A7b_slc)
