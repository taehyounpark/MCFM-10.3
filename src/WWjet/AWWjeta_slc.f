...
!
      subroutine AWWjeta_slc(swap12,swapVV,p,j1,j2,j3,j4,j5,j6,j7,za,zb,swapz,scints,coeff,Alo,A7a_slc)
c--- MCFM notation
...
c      call parser('runWW','SLa',helname,KCD,KCC,KCB,rattot,tot)
c      include 'runSL.f'
...
c      write(6,*)
c      write(6,*) 'SL:Comparison to KCheck'

c      if     ((swap12 .eqv. .false.) .and. (swapVV .eqv. .false.)) then
c      write(6,*) 'd2x56x7sl ',coeff(4,d2x56x7sl )/KCD(d2x56x7sl  )
c      write(6,*) 'd2x7x56sl ',coeff(4,d2x7x56sl )/KCD(d2x7x56sl  )
c      write(6,*) 'd17x2x56sl',coeff(4,d17x2x56sl)/KCD(d17x2x56sl )
c      write(6,*) 'd1x34x7sl ',coeff(4,d1x34x7sl )/KCD(d1x34x7sl  )
c      write(6,*) 'd1x7x34sl ',coeff(4,d1x7x34sl )/KCD(d1x7x34sl  )
c      write(6,*) 'd27x1x34sl',coeff(4,d27x1x34sl)/KCD(d27x1x34sl )
c      write(6,*) 'd2x1x7sl  ',coeff(4,d2x1x7sl  )/KCD(d2x1x7sl   )
c      write(6,*) 'd1x2x7sl  ',coeff(4,d1x2x7sl  )/KCD(d1x2x7sl   )
c      write(6,*) 'd2x1x34sl ',coeff(4,d2x1x34sl )/KCD(d2x1x34sl  )
c      write(6,*) 'd7x34x12sl',coeff(4,d7x34x12sl)/KCD(d7x34x12sl )
c      write(6,*) 'd1x2x56sl ',coeff(4,d1x2x56sl )/KCD(d1x2x56sl  )
c      write(6,*) 'd7x12x34sl',coeff(4,d7x12x34sl)/KCD(d7x12x34sl )
c      write(6,*) 'd7x12x56sl',coeff(4,d7x12x56sl)/KCD(d7x12x56sl )
c      elseif ((swap12 .eqv. .true.) .and. (swapVV .eqv. .true.)) then
c      write(6,*)'d27x1x34sl',KCD(d27x1x34sl)/coeff(4,d17x2x56sl)
c      write(6,*)'d1x2x56sl',KCD(d1x2x56sl)/coeff(4,d2x1x34sl)
c      write(6,*)'d1x34x7sl',KCD(d1x34x7sl)/coeff(4,d2x56x7sl)
c      write(6,*)'d1x2x7sl',KCD(d1x2x7sl)/coeff(4,d2x1x7sl)
c      write(6,*)'d2x1x7sl',KCD(d2x1x7sl)/coeff(4,d1x2x7sl)
c      write(6,*)'d1x7x34sl',KCD(d1x7x34sl)/coeff(4,d2x7x56sl)
c      write(6,*)'d2x1x34sl',KCD(d2x1x34sl)/coeff(4,d1x2x56sl)
c      write(6,*)'d2x56x7sl  ',KCD(d2x56x7sl  )/coeff(4,d1x34x7sl  )
c      write(6,*)'d2x7x56sl  ',KCD(d2x7x56sl  )/coeff(4,d1x7x34sl  )
c      write(6,*)'d17x2x56sl',KCD(d17x2x56sl)/coeff(4,d27x1x34sl)
c      write(6,*)'d7x34x12sl',KCD(d7x34x12sl)/coeff(4,d7x34x12sl)
c      write(6,*)'d7x12x34sl',KCD(d7x12x34sl)/coeff(4,d7x12x56sl)
c      write(6,*)'d7x12x34sl',KCD(d7x12x56sl)/coeff(4,d7x12x34sl)
c      endif
c      write(6,*)
c      if     ((swap12 .eqv. .false.) .and. (swapVV .eqv. .false.)) then
c      write(6,*) 'c56x34sl',coeff(3,c56x34sl)/KCC(c56x34sl)
c      write(6,*) 'c17x34sl',coeff(3,c17x34sl)/KCC(c17x34sl)
...
c      write(6,*) 'c17x34sl',coeff(3,c17x34sl)/KCC(c27x56sl)
c      write(6,*) 'c27x56sl',coeff(3,c27x56sl)/KCC(c17x34sl)
c      write(6,*) 'c12x34sl',coeff(3,c12x34sl)/KCC(c12x56sl)
c      write(6,*) 'c12x56sl',coeff(3,c12x56sl)/KCC(c12x34sl)
c      endif
...
c      if (verbose) then
c      if     ((swap12 .eqv. .false.) .and. (swapVV .eqv. .false.)) then
c        write(6,*) 'b347sl',coeff(2,b347sl)/KCB(b347sl)
c        write(6,*) 'b127sl',coeff(2,b127sl)/KCB(b127sl)
c        write(6,*) 'b567sl',coeff(2,b567sl)/KCB(b567sl)
c        write(6,*) 'b134sl',coeff(2,b134sl)/KCB(b134sl)
c        write(6,*) 'b256sl',coeff(2,b256sl)/KCB(b256sl)
c        write(6,*) 'b17sl ',coeff(2,b17sl)/KCB(b17sl )
c        write(6,*) 'b12sl ',coeff(2,b12sl)/KCB(b12sl )
c        write(6,*) 'b56sl ',coeff(2,b56sl)/KCB(b56sl )
c        write(6,*) 'b34sl ',coeff(2,b34sl)/KCB(b34sl )
c      elseif ((swap12 .eqv. .true.) .and. (swapVV .eqv. .true.)) then
c        write(6,*) 'b127sl',coeff(2,b127sl)/KCB(b127sl)
c        write(6,*) 'b134sl',coeff(2,b134sl)/KCB(b256sl)
c        write(6,*) 'b56sl ',coeff(2,b56sl) /KCB(b34sl )
c        write(6,*) 'b34sl ',coeff(2,b34sl) /KCB(b56sl )
c        write(6,*) 'b256sl',coeff(2,b256sl)/KCB(b134sl)
c        write(6,*) 'b567sl',coeff(2,b567sl)/KCB(b347sl)
c        write(6,*) 'b347sl',coeff(2,b347sl)/KCB(b567sl)
c        write(6,*) 'b17sl ',coeff(2,b17sl) /KCB(b27sl )
c        write(6,*) 'b12sl ',coeff(2,b12sl) /KCB(b12sl )
c      endif
c      endif
...
c      if (verbose) then
c        write(6,*)
c        write(6,*) 'rational',coeff(0,iratsl)/rattot
c      endif
