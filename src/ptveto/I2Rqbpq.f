...
!
      if (x < xmin) then
      I2R(qbpq,rglr)= + R8 * (  - 40*CF*omx**(-7)*Li2mx + 74.D0/3.D0*CF
     ...
     &    863.D0/6.D0*CF*omx**(-1)*lnopxon2 )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + R8 * (  - 5875.D0/18.D0*CF*
     ...
     &    9.D0*CF*pisq*omx**(-5) )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + R8 * ( 1517.D0/18.D0*CF*pisq*
     ...
     &    *CF*ln2*omx**4 + 17.D0/420.D0*CF*ln2*omx**5 )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + R6 * (  - 16*CF*omx**(-5)*Li2mx
     ...
     &    1411200.D0*CF*omx )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + R6 * (  - 50.D0/3.D0*CF*omx*
     ...
     &     + 62.D0/315.D0*CF*ln2*omx**4 )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + R4 * (  - 8*CF*omx**(-3)*Li2mx
     &     + 4*CF*omx**(-3)*lnx + 8*CF*omx**(-3)*Li2omx - 4*CF*
     &    omx**(-2) + 4*CF*omx**(-2)*lnopxon2 + 24*CF*omx**(-2)*Li2mx
     &     - 12*CF*omx**(-2)*lnx - 24*CF*omx**(-2)*Li2omx + 12*CF*
     &    omx**(-1) - 8*CF*omx**(-1)*lnopxon2 - 28*CF*omx**(-1)*Li2mx
     &     + 28*CF*omx**(-1)*lnx + 28*CF*omx**(-1)*Li2omx + 2*CF*
     &    opx**(-2) + 9.D0/2.D0*CF*opx**(-1) - 53.D0/36.D0*CF + 16*CF*
     &    lnopxon2 - 36*CF*lnx - 199111.D0/7200.D0*CF*omx - 12*CF*omx*
     &    lnopxon2 + 20*CF*omx*Li2mx + 16*CF*omx*lnx - 20*CF*omx*Li2omx
     &     + 105341.D0/7200.D0*CF*omx**2 - 8*CF*omx**2*Li2mx + 8*CF*
     &    omx**2*Li2omx - 7141.D0/7200.D0*CF*omx**3 - 2.D0/3.D0*CF*pisq
     &    *omx**(-3) + 2*CF*pisq*omx**(-2) - 7.D0/3.D0*CF*pisq*
     &    omx**(-1) + 5.D0/3.D0*CF*pisq*omx - 2.D0/3.D0*CF*pisq*omx**2
     &     + 8*CF*ln2*omx**(-2) - 20*CF*ln2*omx**(-1) + 56.D0/3.D0*CF*
     &    ln2 + 121.D0/15.D0*CF*ln2*omx - 221.D0/15.D0*CF*ln2*omx**2 + 
     &    16.D0/15.D0*CF*ln2*omx**3 )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + R2 * (  - 8*CF*omx**(-1)*Li2mx
     &     + 8*CF*omx**(-1)*Li2omx - 8*CF + 8*CF*lnx + 49.D0/18.D0*CF*
     &    omx + 8*CF*omx*lnopxon2 + 8*CF*omx*Li2mx - 16*CF*omx*lnx - 8*
     &    CF*omx*Li2omx - 8*CF*omx**2*lnopxon2 + 8*CF*omx**2*lnx - 2.D0/
     &    3.D0*CF*pisq*omx**(-1) + 2.D0/3.D0*CF*pisq*omx + 8*CF*ln2 + 
     &    16.D0/3.D0*CF*ln2*omx - 8*CF*ln2*omx**2 )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + picube * (  - 4*CF*omx**(-1)*
     &    BCQQBARSx + 4*CF*omx**(-1)*BCQQBARS1 + 4*CF*BCQQBARSx )
      else
      I2R(qbpq,rglr)= + R8 * (  - 44803.D0/38707200.D0*CF*omx - 3563.D0/
     ...
     &    D0/648.D0*CF*ln2*omx**10 - 1.D0/81.D0*CF*ln2*omx**11 )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + R6 * ( 473.D0/52920.D0*CF*omx
     ...
     &    ln2*omx**10 - 4.D0/9.D0*CF*ln2*omx**11 )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + R4 * (  - 211.D0/7200.D0*CF*omx
     ...
     &    omx**10 - 8.D0/9.D0*CF*ln2*omx**11 )
      I2R(qbpq,rglr) = I2R(qbpq,rglr) + R2 * (  - 23.D0/18.D0*CF*omx + 
     &    23.D0/9.D0*CF*omx**2 - 11.D0/6.D0*CF*omx**3 - 2059.D0/1800.D0
     &    *CF*omx**4 - 541.D0/720.D0*CF*omx**5 - 30391.D0/58800.D0*CF*
