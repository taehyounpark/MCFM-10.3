...
!
      ...
      implicit none
      include 'types.f'
c input: momenta q, helicity of 5 is h5,
c        flag docc to turn on c.c. - appropriate for t~ calculation
c input momentum pmless is momentum used to make pt massless
c computes currents for given q and helicity combination
c stores as common block as will be re-used.
c add more currents as needed
