...
c                                                                              *
c  Included decays are:                                                        *
c                                                                              *
c    H -> bb, H -> tau tau                                                     *
c    H -> WW, H -> ZZ, H -> gamma gamma                                        *
c                                                                              *
c*******************************************************************************
...
c--- Set up anomalous width of the Higgs boson if required
     ...
     &   .or.(kcase==kqqWZqq) .or. (kcase==kWWqqbr) ) then
          anom_Higgs=.true.
...
c************************** WRITE OUT BRANCHING RATIOS *************************


      if (verbose .and. first .and. rank == 0) then
