...
c*************
      ...
      d13s(1,1)=-TWZbbnr1(p8,p2,p5,p6,p3,p4,p7,p1)
      d13s(1,2)=-TWZbbnr1(p8,p2,p5,p6,p3,p4,p1,p7)
...
c     First index of d123 etc is helicity of Z (56) decay line
c     Second index of d123 etc is helicity of (7) bbar-line

      amp(1,1)=
     &  ((qe*Q(jd)+le*L(jd)*prop56)*d123(1,1)
     ...
     &  +(qe*q3+le*l3*prop56)*d12(1,1)*prop3456
      amps(1,1)=
     &  ((qe*Q(jd)+le*L(jd)*prop56)*d123s(1,1)
     ...
     &  +(qe*q3+le*l3*prop56)*d12s(1,1)*prop3456
      ...
      amp(2,1)=
     &  ((qe*Q(jd)+re*L(jd)*prop56)*d123(2,1)
     ...
     &  +(qe*q3+re*l3*prop56)*d12(2,1)*prop3456
      amps(2,1)=
     &  ((qe*Q(jd)+re*L(jd)*prop56)*d123s(2,1)
     ...
     &  +(qe*q3+re*l3*prop56)*d12s(2,1)*prop3456
      ...
      amp(1,2)=
     &  ((qe*Q(jd)+le*L(jd)*prop56)*d123(1,2)
     ...
     &  +(qe*q3+le*l3*prop56)*d12(1,2)*prop3456
      amps(1,2)=
     &  ((qe*Q(jd)+le*L(jd)*prop56)*d123s(1,2)
     ...
     &  +(qe*q3+le*l3*prop56)*d12s(1,2)*prop3456
      ...
      amp(2,2)=
     &  ((qe*Q(jd)+re*L(jd)*prop56)*d123(2,2)
     ...
     &  +(qe*q3+re*l3*prop56)*d12(2,2)*prop3456
      amps(2,2)=
     &  ((qe*Q(jd)+re*L(jd)*prop56)*d123s(2,2)
