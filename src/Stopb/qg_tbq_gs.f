...
!
      subroutine qg_tbq_gs(p,msq)
      implicit none
      include 'types.f'
c***********************************************************************
c     Real subtraction for t-channel single top, with explicit b-quark *
c                                                                      *
...
c***********************************************************************
c                                                                      *
c    Modified so that off-diagonal subtractions are initial-final      *
c                                                                      *
c***********************************************************************
...
c--- subtractions for massless line
      call      dips(1,p,1,6,5,sub16_5,sub16_5v,msq16_5,msq16_5v,
     & qg_tbq,qg_tbq_gvec)
      call      dips(1,p,5,6,1,sub56_1,dsubv,msq56_1,dummyv,
     & qg_tbq,donothing_gvec)

c--- subtractions for massless line
      call      dips(2,p,2,6,5,sub26_5,sub26_5v,msq26_5,msq26_5v,
     & qg_tbq,qg_tbq_gvec)
...
c--- expressions with the correct gsq for that line
      ...
      if ((ggonly) .and. ((j  /=  0) .or. (k  /=  0))) goto 99
