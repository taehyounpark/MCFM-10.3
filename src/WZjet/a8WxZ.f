...
!
      subroutine a8WxZ(k1,k2,k3,k4,k5,k6,k7,k8,a)
      implicit none
c---- Matrix element for W radiation from line 17
c---- and Z radiation line 28
c---- Four diagrams, before and after on both lines
c     d(-k1) +c(-k2) --> mu^-(k3)+vmu~(k4)+e^-(k5)+e^+(k6)+u(k7)+c(k8)
...
c  Overall factor of  2*i_*gs^2*e^2*gw^2*(T^A)_{i7,i1}*(T^A)_{i8,i2}
...
c     including QED type propagators
      ...
      real(dp):: s3,s4
      complex(dp):: zab2,zaa22,zbb22,ansmm,ansmp
c     amplitude a(h17,h26,h34,h56)
     ...
     & /(s3(k5,k6,k8)*s3(k3,k4,k7)))/(s(k3,k4)*s(k5,k6)*s4(k1,k3,k4,k7))
c      anspm(k1,k2,k3,k4,k5,k6,k7,k8)=(
c     & za(k3,k1)*zab2(k8,k1,k3,k4)*zb(k6,k2)*zab2(k5,k2,k6,k7)
c     & /(s3(k2,k5,k6)*s3(k1,k3,k4))
c     & +za(k8,k1)*zb(k6,k2)*zb(k7,k4)*zaa22(k5,k2,k6,k4,k7,k3)
c     & /(s3(k2,k5,k6)*s3(k3,k4,k7))
c     & +za(k3,k1)*za(k8,k5)*zb(k7,k2)*zbb22(k4,k1,k3,k5,k8,k6)
c     & /(s3(k5,k6,k8)*s3(k1,k3,k4))
c     & +zab2(k3,k4,k7,k2)*za(k5,k8)*zb(k4,k7)*zab2(k1,k5,k8,k6)
c     & /(s3(k5,k6,k8)*s3(k3,k4,k7)))/(s(k3,k4)*s(k5,k6)*s4(k1,k3,k4,k7))
c      anspp(k1,k2,k3,k4,k5,k6,k7,k8)=(
c     & za(k1,k3)*za(k5,k2)*zb(k8,k7)*zbb22(k4,k1,k3,k2,k5,k6)
c     & /(s3(k2,k5,k6)*s3(k1,k3,k4))
c     & +zab2(k3,k4,k7,k8)*za(k5,k2)*zb(k7,k4)*zab2(k1,k2,k5,k6)
c     & /(s3(k2,k5,k6)*s3(k3,k4,k7))
c     & +zab2(k2,k1,k3,k4)*za(k3,k1)*zb(k8,k6)*zab2(k5,k6,k8,k7)
c     & /(s3(k5,k6,k8)*s3(k1,k3,k4))
c     & +za(k1,k2)*zb(k4,k7)*zb(k8,k6)*zaa22(k5,k6,k8,k4,k7,k3)
c     & /(s3(k5,k6,k8)*s3(k3,k4,k7)))/(s(k3,k4)*s(k5,k6)*s4(k1,k3,k4,k7))
      a(1,1)=ansmm(k1,k2,k3,k4,k5,k6,k7,k8)
      a(1,2)=ansmm(k1,k2,k3,k4,k6,k5,k7,k8)
      a(2,1)=ansmp(k1,k2,k3,k4,k5,k6,k7,k8)
      a(2,2)=ansmp(k1,k2,k3,k4,k6,k5,k7,k8)
      return
      end
