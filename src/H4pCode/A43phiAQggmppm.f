...
!
      ...
      function A43phiAQggmppm(j1,j2,j3,j4,za,zb)
      implicit none
      include 'types.f'
...
c---  arXiv:0906.0008 [hep-ph].
      function A43phiAQggmppm_unsym(j1,j2,j3,j4,za,zb)
      implicit none
      include 'types.f'
      complex(dp):: A43phiAQggmppm_unsym
      ...
      include 'epinv.f'
      include 'epinv2.f'
      complex(dp):: V5L,V6l,A0phiAQggmppm,lnrat
...
c--- This is the same function as in the mpmm amplitude
      V5L=
     & -epinv*epinv2-epinv*l12-0.5_dp*l12**2
     & -epinv*epinv2-epinv*l34-0.5_dp*l34**2
     & +epinv*epinv2+epinv*l13+0.5_dp*l13**2
     & +epinv*epinv2+epinv*l24+0.5_dp*l24**2
