...
c      do e=-2,0
c      Cint(1,e)=loopI3(0._dp,0._dp,s12,0._dp,0._dp,0._dp,musq,e)
c      enddo
c      do e=-2,0
c      Cint(2,e)=loopI3(0._dp,s134,s34,0._dp,0._dp,mtsq,musq,e)
c      enddo
c      do e=-2,0
c      Cint(3,e)=loopI3(0._dp,s56,s134,0._dp,0._dp,mtsq,musq,e)
c      enddo
c      do e=-2,0
c      Cint(4,e)=loopI3(0._dp,s156,s56,0._dp,0._dp,mtsq,musq,e)
c      enddo
c      do e=-2,0
c      Cint(5,e)=loopI3(0._dp,s34,s156,0._dp,0._dp,mtsq,musq,e)
c      enddo
      do e=-2,0
      Cint(6,e)=loopI3(s12,s56,s34,0._dp,0._dp,mtsq,musq,e)
      enddo
      do e=-2,0
      Cint(7,e)=loopI3(s134,0._dp,s34,0._dp,mtsq,mtsq,musq,e)
      enddo
      do e=-2,0
      Cint(8,e)=loopI3(s56,0._dp,s134,0._dp,mtsq,mtsq,musq,e)
      enddo
      do e=-2,0
      Cint(9,e)=loopI3(s156,0._dp,s56,0._dp,mtsq,mtsq,musq,e)
      enddo
      do e=-2,0
      Cint(10,e)=loopI3(s34,0._dp,s156,0._dp,mtsq,mtsq,musq,e)
      enddo
      do e=-2,0
         Cint(11,e)=loopI3(s56,s12,s34,0._dp,mtsq,mtsq,musq,e)
      enddo
      do e=-2,0
      Cint(12,e)=loopI3(s12,0._dp,0._dp,mtsq,mtsq,mtsq,musq,e)
      enddo
