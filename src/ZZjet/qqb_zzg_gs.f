...
!
      subroutine qqb_zzg_gs(p,msq)
c***********************************************************************
c     Author: J.M.Campbell                                             *
c     April, 2020.                                                     *
c***********************************************************************
c---Matrix element SUBTRACTION squared averaged over initial colors and spins
c     q(-p1)+qbar(-p2) -->  Z Z parton(p7) + parton(p8) + g(p7)
c                           | |
c                           | ---> l(p5)+a(p6)
c                           |
c                            -->l(p3)+a(p4)
...
c--- q-g and qb-g cases
      msq(2,j,k)=2._dp*tr*(msq27_1(j,-5)+msq27_1(j,-4)+msq27_1(j,-3)
     &                  +msq27_1(j,-2)+msq27_1(j,-1)+msq27_1(j,+1)
     &                  +msq27_1(j,+2)+msq27_1(j,+3)+msq27_1(j,+4)+msq27_1(j,+5)
     &                  )*sub27_1(qg)
...
c--- g-q and g-qb cases
      msq(1,j,k)=2._dp*tr*(msq17_2(-5,k)+msq17_2(-4,k)+msq17_2(-3,k)
     &                  +msq17_2(-2,k)+msq17_2(-1,k)+msq17_2(+1,k)
     &                  +msq17_2(+2,k)+msq17_2(+3,k)+msq17_2(+4,k)+msq17_2(+5,k)
     &                  )*sub17_2(qg)
...
c--- note g,g = 1,2 and q=7, qb=8 so (17),(27)-->qb and (18),(28)-->q
     ...
     &           +msq17_2(-4,k)+msq17_2(-5,k))*sub17_2(qg)*2._dp*tr
      msq(2,j,k)=(msq27_1(k,-1)+msq27_1(k,-2)+msq27_1(k,-3)
     &           +msq27_1(k,-4)+msq27_1(k,-5))*sub27_1(qg)*2._dp*tr
      msq(3,j,k)=(msq18_2(+5,k)+msq18_2(+4,k)+msq18_2(+3,k)
     &           +msq18_2(+2,k)+msq18_2(+1,k))*sub18_2(qg)*2._dp*tr
      msq(4,j,k)=(msq28_1(k,+5)+msq28_1(k,+4)+msq28_1(k,+3)
     &           +msq28_1(k,+2)+msq28_1(k,+1))*sub28_1(qg)*2._dp*tr
...
c--- Q QBAR
     ...
     &    *(msq17_2(0,k)*sub17_2(gq)+msq17_2v(0,k)*sub17_2v)
        msq(4,j,k)=msq(4,j,k)+(xn-1._dp/xn)
     &    *(msq28_1(j,0)*sub28_1(gq)+msq28_1v(j,0)*sub28_1v)
        msq(5,j,k)=msq(5,j,k)+tr*nf
     &    *(msq18_7(j,k)*sub78_1(gq)-msq78_1v(j,k)*sub78_1v)
        msq(6,j,k)=msq(6,j,k)+tr*nf
