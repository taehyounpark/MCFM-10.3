...
!
      subroutine AZZsr1(Qid,h12,h34,h56,Alo,Av,j1,j2,j3,j4,j5,j6,j7,za,zb)
      implicit none
      include 'types.f'
      include 'mxpart.f'
      include 'epinv.f'
      ...
      integer j1,j2,j3,j4,j5,j6,j7,Qid,h12,h34,h56
      real(dp):: s123
      complex(dp):: l12,l23,L0,L1,Lsm1,Alo,Anlo(-2:0)
      complex(dp):: lnrat,ZZcurr_sr,Av
...
c      A5lom =-za(j3,j4)**2/(za(j1,j2)*za(j2,j3)*za(j4,j5))
      Alo =-(za(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5,za,zb)
     &      +za(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j2,j5,za,zb))
...
c     &   *L0(-s(j2,j3),-s(j4,j5))/s(j4,j5))
      ...
      Anlo(0)=Anlo(0)
     & +(za(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5,za,zb)
     &  +za(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j2,j5,za,zb))
     &  /(za(j1,j2)*za(j2,j3)*s123)
     &  *Lsm1(-s(j1,j2),-s123,-s(j2,j3),-s123)
     & -2d0*za(j1,j3)/(za(j1,j2)*za(j2,j3))
     &  *ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5,za,zb)
...
c     & /(za(j1,j2)*za(j2,j3))*L1(-s(j2,j3),-s123)/s123**2
      ...
      Anlo(0)=Anlo(0)
     & +za(j1,j3)/(za(j1,j2)*za(j2,j3))*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5,za,zb)
     &  *L0(-s(j2,j3),-s123)/s123
     & +0.5d0*za(j1,j3)**2/(za(j1,j2)*za(j2,j3))
     &  *(zb(j1,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j1,j5,za,zb)
     &   +zb(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5,za,zb))
...
c!! c      write(6,*) 'AZZsr1 Alo',Alo
c!! c      write(6,'(a15,g24.15)') 'AZZsr1 abs(Alo)=',cdabs(Alo)
c!!
c!! c      write(6,*) 'AZZsr1 Anlo(-2)',Anlo(-2)
c!! c      write(6,*) 'AZZsr1 Anlo(-1)',Anlo(-1)
c!! c      write(6,*) 'AZZsr1 Anlo( 0)',Anlo( 0)
c!! c      write(6,'(a19,2g24.15)') 'AZZsr1 Anlo(-2)/Alo=',Anlo(-2)/Alo
c!! c      write(6,'(a19,2g24.15)') 'AZZsr1 Anlo(-1)/Alo=',Anlo(-1)/Alo
c!! c      write(6,'(a19,2g24.15)') 'AZZsr1 Anlo( 0)/Alo=',Anlo( 0)/Alo
c!!
c!!       boxcoeff=
c!!      & +(za(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5,za,zb)
c!!      &  +za(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j2,j5,za,zb))
c!!      &  /(za(j1,j2)*za(j2,j3)*s123)
c!!      &  *s(j1,j2)*s(j2,j3)/2d0
c!!
c!!       bubcoeff=
c!!      & -2d0*za(j1,j3)/(za(j1,j2)*za(j2,j3))
c!!      &  *ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5,za,zb)
c!!      &  /(1d0-s(j2,j3)/s123)/s123
c!!
c!! c--- old version
c!!       bubcoeff=bubcoeff
c!!      & +za(j1,j3)/(za(j1,j2)*za(j2,j3))*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5,za,zb)
c!!      &  /(1d0-s(j2,j3)/s123)/s123
c!!      & +0.5d0*za(j1,j3)**2/(za(j1,j2)*za(j2,j3))
c!!      &  *(zb(j1,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j1,j5,za,zb)
c!!      &   +zb(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5,za,zb))
c!!      &  /(1d0-s(j2,j3)/s123)**2/s123**2
c!!
c!! c--- new version
c!! c      bubcoeff=bubcoeff
c!! c     & +za(j1,j3)/(za(j1,j2)*za(j2,j3))*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5)
c!! c     &  /(1d0-s(j2,j3)/s123)/s123
c!! c     & +0.5d0*za(j3,j1)/(za(j1,j2)*za(j2,j3))
c!! c     &       *(za(j1,j2)*zb(j2,j1)+za(j1,j3)*zb(j3,j1))
c!! c     &  *ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5)
c!! c     &  /(1d0-s(j2,j3)/s123)**2/s123**2
c!! c     & -0.5d0*za(j3,j1)/(za(j1,j2)*za(j2,j3))
c!! c     &       *za(j2,j3)*zb(j1,j2)
c!! c     &  *ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j1,j5)
c!! c     &  /(1d0-s(j2,j3)/s123)**2/s123**2
c!!
c!!
...
c!!       end
      ...
      subroutine AZZsr2(Qid,h12,h34,h56,Alo,Av,j1,j2,j3,j4,j5,j6,j7,za,zb)
      implicit none
      include 'types.f'
      include 'mxpart.f'
      include 'epinv.f'
...
c      Alom=za(j2,j4)**2/(za(j2,j3)*za(j3,j1)*za(j4,j5))
      Alo =-(za(j2,j1)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j1,j5,za,zb)
     &      +za(j2,j3)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j3,j5,za,zb))
...
c--subleading N
      Anlo(0)=Anlo(0)
     & -(za(j2,j1)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j1,j5,za,zb)
     &  +za(j2,j3)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j3,j5,za,zb))
     &  /(za(j2,j3)*za(j3,j1)*s123)
     &  *Lsm1(-s(j1,j2),-s123,-s(j1,j3), -s123)
     & +(za(j1,j2)*za(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j1,j5,za,zb)
     &  +za(j1,j2)*za(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j2,j5,za,zb)
     &  -za(j1,j2)*za(j2,j3)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j2,j5,za,zb)
     &  -za(j1,j3)*za(j2,j3)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j3,j5,za,zb))
     &  /(za(j2,j3)*za(j1,j3)**2*s123)
     &  *Lsm1(-s(j1,j2),-s123,-s(j2,j3),-s123)

     & +2d0*zb(j1,j3)/(za(j1,j3)*s123)
     & *(za(j1,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j2,j5,za,zb)
     &  +za(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j3,j5,za,zb))
     & *L0(-s(j2,j3),-s123)/s123
...
c      Vsc=0.5d0*(epinv+l123)+0.5d0
      ...
      Anlo(0)=Anlo(0)
     & +(za(j1,j2)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j2,j5,za,zb)
     &  +za(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j3,j5,za,zb))
     ...
     & +za(j2,j1)*zb(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j3,j5,za,zb)/za(j1,j3)
     & *L1(-s123,-s(j1,j2))/s(j1,j2)**2

     & -za(j2,j1)*zb(j1,j3)/(za(j1,j3)**2*s123)
     & *(za(j1,j2)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j2,j5,za,zb)
     &  +za(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j3,j5,za,zb))
     & *L0(-s123,-s(j1,j2))/s(j1,j2)

     & +0.5d0*zb(j1,j3)
     & *(zb(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j2,j5,za,zb)
     &  +zb(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j2,j5,za,zb))
     & /(zb(j1,j2)*zb(j2,j3)*za(j1,j3)*s123)

     & +0.5d0*zb(j2,j3)
     & *(zb(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j1,j5,za,zb)
     &  +zb(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j1,j5,za,zb))
     & /(zb(j1,j2)*zb(j2,j3)*za(j1,j3)*s123)
...
c      write(6,*)
c      write(6,*) 'AZZsr2 Alo',Alo
c      write(6,'(a15,g24.15)') 'AZZsr2 abs(Alo)=',cdabs(Alo)

c      write(6,*) 'AZZsr2 Anlo(-2)',Anlo(-2)
c      write(6,*) 'AZZsr2 Anlo(-1)',Anlo(-1)
c      write(6,*) 'AZZsr2 Anlo( 0)',Anlo( 0)
c      write(6,'(a19,2g24.15)') 'AZZsr2 Anlo(-2)/Alo=',Anlo(-2)/Alo
c      write(6,'(a19,2g24.15)') 'AZZsr2 Anlo(-1)/Alo=',Anlo(-1)/Alo
c      write(6,'(a19,2g24.15)') 'AZZsr2 Anlo( 0)/Alo=',Anlo( 0)/Alo
...
c!!       boxcoeff1=
c!!      & -(za(j2,j1)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j1,j5)
c!!      &  +za(j2,j3)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j3,j5))
c!!      &  /(za(j2,j3)*za(j3,j1)*s123)
c!!      &  *s(j1,j2)*s(j1,j3)/2d0
c!! c--- this version is direct from paper
c!!       boxcoeff2=(
c!!      & +(za(j1,j2)*za(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j1,j5)
c!!      &  +za(j1,j2)*za(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j2,j5)
c!!      &  -za(j1,j2)*za(j2,j3)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j2,j5)
c!!      &  -za(j1,j3)*za(j2,j3)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j3,j5))
c!!      &  /(za(j2,j3)*za(j1,j3)**2*s123)
c!!      & +(za(j1,j2)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j2,j5)
c!!      &  +za(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j3,j5))
c!!      &  *za(j2,j3)/(za(j1,j3)**3*s123)
c!!      &  )*s(j1,j2)*s(j2,j3)/2d0
c!! c--- this version has been simplified by hand
c!! c      boxcoeff2=za(j1,j2)**2
c!! c     & *(za(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j1,j5)
c!! c     &  +za(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j2,j5))
...
c!!
c!!       bubcoeff=
c!!      & +za(j2,j1)*zb(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j3,j5)/za(j1,j3)
c!!      & /(1d0-s123/s(j1,j2))**2/s(j1,j2)**2
c!!
c!!      & -za(j2,j1)*zb(j1,j3)/(za(j1,j3)**2*s123)
c!!      & *(za(j1,j2)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j2,j5)
c!!      &  +za(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j3,j5))
...
c!!      & *(za(j1,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j2,j5)
c!!      &  +za(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j3,j5))
c!!      & /(1d0-s(j2,j3)/s123)/s123
c!!
c!!       bubcoeffb=
...
c!! c     & *(za(j1,j2)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j2,j5)
c!! c     &  +za(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j3,j5))
c!! c     & /(1d0-s123/s(j2,j3))/s(j2,j3)**2 ! from L1
c!! c
c!! c     & +za(j2,j1)*zb(j1,j3)*ZZcurr_sr(Qid,h12,h34,h56,j3,j4,j3,j5)/za(j1,j3)
c!! c     & /(1d0-s123/s(j1,j2))/s(j1,j2)**2 ! from L1
c!! c
c!! c     & +0.5d0*zb(j1,j3)
c!! c     & *(zb(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j2,j5)
c!! c     &  +zb(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j2,j5))
c!! c     & /(zb(j1,j2)*zb(j2,j3)*za(j1,j3)*s123)
c!! c
c!! c     & +0.5d0*zb(j2,j3)
c!! c     & *(zb(j3,j1)*ZZcurr_sr(Qid,h12,h34,h56,j1,j4,j1,j5)
c!! c     &  +zb(j3,j2)*ZZcurr_sr(Qid,h12,h34,h56,j2,j4,j1,j5))
c!! c     & /(zb(j1,j2)*zb(j2,j3)*za(j1,j3)*s123)
