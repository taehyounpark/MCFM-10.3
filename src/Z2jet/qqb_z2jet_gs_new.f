...
c--- 10/17/18: proper combination of final-initial and final-final for consistency with Gflag
     ...
     & *(sub65_7(gq)*(m65_7g(1,j,k)+m65_7g(2,j,k))
     &     -sub65_7v*(m65_7vg(1,j,k)+m65_7vg(2,j,k)))
      msq( 7,j,k)=msq( 7,j,k)+real(nf,dp)
     & *(sub65_1(gq)*(m15_6g(0,j,k)+m15_6g(1,j,k))
     &     -sub65_1v*(m65_1vg(0,j,k)+m65_1vg(1,j,k)))
      msq(18,j,k)=msq(18,j,k)+real(nf,dp)
     & *(sub65_2(gq)*(m25_6g(0,j,k)+m25_6g(2,j,k))
     &     -sub65_2v*(m65_2vg(0,j,k)+m65_2vg(2,j,k)))
...
c--- 10/17/18: proper combination of final-initial and final-final for consistency with Gflag
     ...
     &     -sub65_7v*(m65_7vg(1,j,k)+m65_7vg(2,j,k)))
      msq( 7,j,k)=msq( 7,j,k)+real(nf,dp)
     & *(sub65_1(gq)*(m15_6g(0,j,k)+m15_6g(2,j,k))
     &     -sub65_1v*(m65_1vg(0,j,k)+m65_1vg(2,j,k)))
      msq(18,j,k)=msq(18,j,k)+real(nf,dp)
     & *(sub65_2(gq)*(m25_6g(0,j,k)+m25_6g(1,j,k))
     &     -sub65_2v*(m65_2vg(0,j,k)+m65_2vg(1,j,k)))
