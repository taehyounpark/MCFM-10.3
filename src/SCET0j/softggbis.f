...
c#################################################################
c##### O(as) soft contribution to tau_1, calculates soft1(-1:1)
c##### contributions to delta(tau1), L0(tau1) and L1(tau1)
c##### returns integrated contribution.
c##### a factor of alphas/2/pi has been extracted out
c##### see Eq. (2.22) of 1012.4480,
c#################################################################
c This file is created using the color factor swap result of
c Idilbi et al., hep-ph/0605068v2
...
c---- contribution to delta(tau1)
      soft1(-1) = CA*pisqo6
c---- contribution to L0(tau1)
      soft1(0) = 0.0_dp
c---- contribution to L1(tau1)
      soft1(1) =-8*CA
...
c---- contribution to L2(tau1)
      soft2(2) = 4*CA*be0
c---- contribution to L3(tau1)
      soft2(3) = 32*CA**2
