...
c--- with full top mass dependence
     ...
     & R(cmax)
      ...
      Dcoeff(d3x4x12)=-aqppD4x3x21(p1,p2,p4,p3,mtsq,za,zb)
      Dcoeff(d4x3x21)=+aqppD4x3x21(p1,p2,p3,p4,mtsq,za,zb)
      Dcoeff(d4x12x3)=+aqppD3x21x4(p1,p2,p3,p4,mtsq,za,zb)

      Ccoeff(c3x21)=+aqppC3x12(p1,p2,p3,p4,za,zb)
      Ccoeff(c4x12)=-aqppC3x12(p1,p2,p4,p3,za,zb)
      Ccoeff(c12x34)=+aqppC12x34(p1,p2,p3,p4,mtsq,za,zb,R(c12x34))
      Ccoeff(c4x123)=+aqppC4x123(p1,p2,p3,p4,mtsq,za,zb,R(c4x123))
      Ccoeff(c3x412)=+aqppC3x412(p1,p2,p3,p4,mtsq,za,zb,R(c3x412))

      Bcoeff(b12)=+aqppB12(p1,p2,p3,p4,za,zb)
      Bcoeff(b412)=+aqpmppB412(p1,p2,p3,p4,za,zb)
      Bcoeff(b123)=+aqpmppB123(p1,p2,p3,p4,za,zb)
      Bcoeff(b1234)=-Bcoeff(b12)-Bcoeff(b123)-Bcoeff(b412)

c      Rat=
c     &-(-aqppC12x34m2(p1,p2,p3,p4,mtsq,za,zb)
c     &  -aqppC4x123m2(p1,p2,p3,p4,mtsq,za,zb)
c     &  -aqppC3x412m2(p1,p2,p3,p4,mtsq,za,zb))/two
