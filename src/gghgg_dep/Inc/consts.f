...
c sqrt(two/pi)
      real(dp),parameter::rt2onpi=0.79788456080286537143134772248787_dp

      complex(dp), parameter :: im=(zero,one)
      complex(dp), parameter :: impi=(zero,pi)
      complex(dp), parameter :: czero=(zero,zero)
      complex(dp), parameter :: czip=(zero,zero)
      complex(dp), parameter :: cone=(one,zero)
      complex(dp), parameter :: ctwo=(two,zero)
      complex(dp), parameter :: chalf=(half,zero)
...
c----decifemtobarns
      ...
      integer, parameter :: nloop=2, fn=-5, nf=5
