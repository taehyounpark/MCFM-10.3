...
c     Implementation of Eq.~(10.2) from arXiv:2002.04018 v2
      ...
      complex(dp):: aqpmC4x123m0_res,zab2
      ...
      aqpmC4x123m0_res =
     & (-2*za(p3,p4)*zab2(p2,p1,p3,p4)**2*s123)
     & /(za(p1,p2)*zab2(p3,p1,p2,p4)**3) +
     & (+2*za(p2,p4)*zab2(p2,p1,p3,p4)*s123)
     & /(za(p1,p2)*zab2(p3,p1,p2,p4)**2) +
     & (-za(p2,p4)**2*zab2(p2,p1,p3,p4))
     & /(za(p1,p2)*za(p2,p3)*zab2(p3,p1,p2,p4)) +
     & (zb(p1,p3)**2*s14p24p34)
     & /(zb(p1,p2)*zb(p3,p4)*zab2(p3,p1,p2,p4)) +
