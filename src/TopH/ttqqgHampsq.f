...
!
     ...
     & T21x34(2,2,2,2,2),T24x31(2,2,2,2,2),T31x24(2,2,2,2,2)
      ...
      p5(:)=cmplx(q(q5,:),kind=dp)
      et1(:)=cmplx(q(eta1,:),kind=dp)
      et2(:)=cmplx(q(eta2,:),kind=dp)
      p15(:)=cmplx(q(q1,:)+q(q5,:),kind=dp)
      p25(:)=cmplx(q(q2,:)+q(q5,:),kind=dp)
      p34(:)=cmplx(q(q3,:)+q(q4,:),kind=dp)
      p45(:)=cmplx(q(q4,:)+q(q5,:),kind=dp)
      p35(:)=cmplx(q(q3,:)+q(q5,:),kind=dp)
      p345(:)=cmplx(q(q3,:)+q(q4,:)+q(q5,:),kind=dp)
      p1345(:)=cmplx(q(q1,:)+q(q3,:)+q(q4,:)+q(q5,:),kind=dp)
      p2345(:)=cmplx(q(q2,:)+q(q3,:)+q(q4,:)+q(q5,:),kind=dp)
