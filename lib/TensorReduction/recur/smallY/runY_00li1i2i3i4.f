      subroutine runY_00li1i2i3i4(k,l,i1,i2,i3,i4,Xtwiddle,Gtwiddle,
     . Shat7,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Calculates D00li1i2i3i4, requires D00lli1i2i3
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1.eq.0) .or. (i2.eq.0) .or. (i3.eq.0) .or. (i4.eq.0)) then
      ...
      do ep=-2,0
      Dv(dzziiiii(z5(l,i1,i2,i3,i4))+N0,ep)=
     .(-2d0*Gtwiddle(k,i1)*Dv(dzziiiii(z5(l,l,i2,i3,i4))+N0,ep)
     . -2d0*Gtwiddle(k,i2)*Dv(dzziiiii(z5(l,l,i1,i3,i4))+N0,ep)
     . -2d0*Gtwiddle(k,i3)*Dv(dzziiiii(z5(l,l,i1,i2,i4))+N0,ep)
     . -2d0*Gtwiddle(k,i4)*Dv(dzziiiii(z5(l,l,i1,i2,i3))+N0,ep)
     . +Gtwiddle(k,1)*Shat7(1,z6(l,l,i1,i2,i3,i4),ep)
     . +Gtwiddle(k,2)*Shat7(2,z6(l,l,i1,i2,i3,i4),ep)
     . +Gtwiddle(k,3)*Shat7(3,z6(l,l,i1,i2,i3,i4),ep)
     . +Xtwiddle(k,0)*Dv(diiiiii(z6(l,l,i1,i2,i3,i4))+N0,ep)
     . -Xtwiddle(0,0)*Dv(diiiiiii(z7(k,l,l,i1,i2,i3,i4))+N0,ep))
     . /(4d0*Gtwiddle(k,l))
