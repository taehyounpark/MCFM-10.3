      subroutine runY_00llli1i2(k,l,i1,i2,Xtwiddle,Gtwiddle,Shat7,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Calculates D00lli1i2, requires D00lllli1
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1 .eq. 0) .or. (i2 .eq. 0)) then
      ...
      do ep=-2,0
      Dv(dzziiiii(z5(l,l,l,i1,i2))+N0,ep)=
     .(-2d0*Gtwiddle(k,i1)*Dv(dzziiiii(z5(l,l,l,l,i2))+N0,ep)
     . -2d0*Gtwiddle(k,i2)*Dv(dzziiiii(z5(l,l,l,l,i1))+N0,ep)
     . +Gtwiddle(k,1)*Shat7(1,z6(l,l,l,l,i1,i2),ep)
     . +Gtwiddle(k,2)*Shat7(2,z6(l,l,l,l,i1,i2),ep)
     . +Gtwiddle(k,3)*Shat7(3,z6(l,l,l,l,i1,i2),ep)
     . +Xtwiddle(k,0)*Dv(diiiiii(z6(l,l,l,l,i1,i2))+N0,ep)
     . -Xtwiddle(0,0)*Dv(diiiiiii(z7(k,l,l,l,l,i1,i2))+N0,ep))
     . /(8d0*Gtwiddle(k,l))
