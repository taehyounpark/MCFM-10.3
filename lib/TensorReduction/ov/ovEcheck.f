...
c      enddo
      ...
      call ovDtensor(q2,p3,p4,m1s,m3s,m4s,m5s,
     & FD01,FD11,FD21,FD31,FD41,FD51,FD61)
      call ovDtensor(q1,p23,p4,m1s,m2s,m4s,m5s,
     & FD02,FD12,FD22,FD32,FD42,FD52,FD62)
      call ovDtensor(q1,p2,p34,m1s,m2s,m3s,m5s,
     & FD03,FD13,FD23,FD33,FD43,FD53,FD63)
      call ovDtensor(q1,p2,p3,m1s,m2s,m3s,m4s,
